...
class IntTools:
	...
	@staticmethod
	def GetRadius(self, C: BRepAdaptor_Curve, t1: float, t3: float, R: float) -> int: ...
	@staticmethod
	def Length(self, E: TopoDS_Edge) -> float: ...
	@staticmethod
	def Parameter(self, P: gp_Pnt, Curve: Geom_Curve, aParm: float) -> int: ...
	@staticmethod
...
class IntTools_CommonPrt:
	...
	def Range1(self, tf: float, tl: float) -> None: ...
...
class IntTools_Context(Standard_Transient):
	...
	def ComputePE(self, theP: gp_Pnt, theTolP: float, theE: TopoDS_Edge, theT: float, theDist: float) -> int: ...
	def ComputeVE(self, theV: TopoDS_Vertex, theE: TopoDS_Edge, theT: float, theTol: float, theFuzz: Optional[float]) -> int: ...
	def ComputeVF(self, theVertex: TopoDS_Vertex, theFace: TopoDS_Face, theU: float, theV: float, theTol: float, theFuzz: Optional[float]) -> int: ...
	...
	def IsVertexOnLine(self, aV: TopoDS_Vertex, aIC: IntTools_Curve, aTolC: float, aT: float) -> bool: ...
	def IsVertexOnLine(self, aV: TopoDS_Vertex, aTolV: float, aIC: IntTools_Curve, aTolC: float, aT: float) -> bool: ...
	...
	def ProjectPointOnEdge(self, aP: gp_Pnt, aE: TopoDS_Edge, aT: float) -> bool: ...
	...
	def UVBounds(self, theFace: TopoDS_Face, UMin: float, UMax: float, VMin: float, VMax: float) -> None: ...

class IntTools_Curve:
	def Bounds(self, theFirst: float, theLast: float, theFirstPnt: gp_Pnt, theLastPnt: gp_Pnt) -> bool: ...
...
class IntTools_PntOnFace:
	...
	def __init__(self) -> None: ...
	def Parameters(self, U: float, V: float) -> None: ...
	def Pnt(self) -> gp_Pnt: ...
...
class IntTools_Range:
	...
	def Last(self) -> float: ...
	def Range(self, aFirst: float, aLast: float) -> None: ...
...
class IntTools_Root:
	...
	def Interval(self, t1: float, t2: float, f1: float, f2: float) -> None: ...
	def IsValid(self) -> bool: ...
...
class IntTools_ShrunkRange:
	...
	def ShrunkRange(self, aT1: float, aT2: float) -> None: ...
...
class IntTools_SurfaceRangeSample:
	...
	def GetDepths(self, theDepthU: int, theDepthV: int) -> None: ...
	def GetIndexU(self) -> int: ...
	def GetIndexV(self) -> int: ...
	def GetIndexes(self, theIndexU: int, theIndexV: int) -> None: ...
...
class IntTools_Tools:
	...
	@staticmethod
	def ComputeTolerance(self, theCurve3D: Geom_Curve, theCurve2D: Geom2d_Curve, theSurf: Geom_Surface, theFirst: float, theLast: float, theMaxDist: float, theMaxPar: float, theTolRange: Optional[float]) -> bool: ...
	@staticmethod
	...
	@staticmethod
	def SegPln(self, theLin: gp_Lin, theTLin1: float, theTLin2: float, theTolLin: float, thePln: gp_Pln, theTolPln: float, theP: gp_Pnt, theT: float, theTolP: float, theTmin: float, theTmax: float) -> int: ...
	@staticmethod
	def SplitCurve(self, aC: IntTools_Curve, aS: IntTools_SequenceOfCurves) -> int: ...
	@staticmethod
	def VertexParameter(self, theCP: IntTools_CommonPrt, theT: float) -> None: ...
	@staticmethod
	def VertexParameters(self, theCP: IntTools_CommonPrt, theT1: float, theT2: float) -> None: ...
