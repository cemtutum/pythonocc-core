...
class Geom2d_BSplineCurve(Geom2d_BoundedCurve):
	...
	def MovePoint(self, U: float, P: gp_Pnt2d, Index1: int, Index2: int, FirstModifiedPole: int, LastModifiedPole: int) -> None: ...
	def MovePointAndTangent(self, U: float, P: gp_Pnt2d, Tangent: gp_Vec2d, Tolerance: float, StartingCondition: int, EndingCondition: int, ErrorStatus: int) -> None: ...
	...
	def Resolution(self, ToleranceUV: float, UTolerance: float) -> None: ...
	def Reverse(self) -> None: ...
	def ReversedParameter(self, U: float) -> float: ...
