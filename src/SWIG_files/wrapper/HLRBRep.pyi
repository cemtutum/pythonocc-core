...
class HLRBRep:
	...
	@staticmethod
	def PolyHLRAngleAndDeflection(self, InAngl: float, OutAngl: float, OutDefl: float) -> None: ...
...
class HLRBRep_Curve:
	...
	def Update(self, TotMin[16]: float, TotMax[16]: float) -> float: ...
	def UpdateMinMax(self, TotMin[16]: float, TotMax[16]: float) -> float: ...
...
class HLRBRep_CurveTool:
	...
	@staticmethod
	def GetInterval(self, C: None, Index: int, Tab: TColStd_Array1OfReal, U1: float, U2: float) -> None: ...
	@staticmethod
...
class HLRBRep_Data(Standard_Transient):
	...
	def Classify(self, E: int, ED: HLRBRep_EdgeData, LevelFlag: bool, Level: int, param: float) -> TopAbs_State: ...
	...
	def LocalFEGeometry2D(self, FE: int, Param: float, Tg: gp_Dir2d, Nm: gp_Dir2d, Cu: float) -> None: ...
	def LocalLEGeometry2D(self, Param: float, Tg: gp_Dir2d, Nm: gp_Dir2d, Cu: float) -> None: ...
...
class HLRBRep_EdgeFaceTool:
	...
	@staticmethod
	def UVPoint(self, Par: float, E: None, F: None, U: float, V: float) -> bool: ...
...
class HLRBRep_EdgeInterferenceTool:
	...
	def EdgeGeometry(self, Param: float, Tgt: gp_Dir, Nrm: gp_Dir, Curv: float) -> None: ...
	def __init__(self, DS: HLRBRep_Data) -> None: ...
	def InitVertices(self) -> None: ...
	def InterferenceBoundaryGeometry(self, I: HLRAlgo_Interference, Tang: gp_Dir, Norm: gp_Dir, Curv: float) -> None: ...
	def IsPeriodic(self) -> bool: ...
...
class HLRBRep_ExactIntersectionPointOfTheIntPCurvePCurveOfCInter:
	...
	def Perform(self, Poly1: HLRBRep_ThePolygon2dOfTheIntPCurvePCurveOfCInter, Poly2: HLRBRep_ThePolygon2dOfTheIntPCurvePCurveOfCInter, NumSegOn1: int, NumSegOn2: int, ParamOnSeg1: float, ParamOnSeg2: float) -> None: ...
	def Perform(self, Uo: float, Vo: float, UInf: float, VInf: float, USup: float, VSup: float) -> None: ...
	def Roots(self, U: float, V: float) -> None: ...
...
class HLRBRep_PolyAlgo(Standard_Transient):
	...
	def Hide(self, status: HLRAlgo_EdgeStatus, S: TopoDS_Shape, reg1: bool, regn: bool, outl: bool, intl: bool) -> False: ...
	...
	def Show(self, S: TopoDS_Shape, reg1: bool, regn: bool, outl: bool, intl: bool) -> False: ...
...
class HLRBRep_SLPropsATool:
	@staticmethod
	def Bounds(self, A: None, U1: float, V1: float, U2: float, V2: float) -> None: ...
	@staticmethod
...
class HLRBRep_ShapeBounds:
	def Bounds(self, V1: int, V2: int, E1: int, E2: int, F1: int, F2: int) -> None: ...
	def __init__(self) -> None: ...
	...
	def Sizes(self, NV: int, NE: int, NF: int) -> None: ...
...
class HLRBRep_TheIntersectorOfTheIntConicCurveOfCInter(IntRes2d_Intersection):
	def And_Domaine_Objet1_Intersections(self, TheImpTool: IntCurve_IConicTool, TheParCurve: None, TheImpCurveDomain: IntRes2d_Domain, TheParCurveDomain: IntRes2d_Domain, NbResultats: int, Inter2_And_Domain2: TColStd_Array1OfReal, Inter1: TColStd_Array1OfReal, Resultat1: TColStd_Array1OfReal, Resultat2: TColStd_Array1OfReal, EpsNul: float) -> None: ...
...
class HLRBRep_ThePolyhedronToolOfInterCSurf:
	...
	@staticmethod
	def TriConnex(self, thePolyh: HLRBRep_ThePolyhedronOfInterCSurf, Triang: int, Pivot: int, Pedge: int, TriCon: int, OtherP: int) -> int: ...
	@staticmethod
	def Triangle(self, thePolyh: HLRBRep_ThePolyhedronOfInterCSurf, Index: int, P1: int, P2: int, P3: int) -> None: ...
