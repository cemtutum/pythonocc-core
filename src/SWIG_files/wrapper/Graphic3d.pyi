...
class Graphic3d_ArrayOfPrimitives(Standard_Transient):
	...
	def BoundColor(self, theRank: int, theR: float, theG: float, theB: float) -> None: ...
	...
	def VertexColor(self, theRank: int, theR: float, theG: float, theB: float) -> None: ...
	def VertexColor(self, theRank: int, theColor: int) -> None: ...
	def VertexNormal(self, theRank: int) -> gp_Dir: ...
	def VertexNormal(self, theRank: int, theNX: float, theNY: float, theNZ: float) -> None: ...
	def VertexNumber(self) -> int: ...
	def VertexNumberAllocated(self) -> int: ...
	def VertexTexel(self, theRank: int) -> gp_Pnt2d: ...
	def VertexTexel(self, theRank: int, theTX: float, theTY: float) -> None: ...
	def Vertice(self, theRank: int) -> gp_Pnt: ...
	def Vertice(self, theRank: int, theX: float, theY: float, theZ: float) -> None: ...
...
class Graphic3d_Aspects(Standard_Transient):
	...
	def PolygonOffsets(self, theMode: int, theFactor: Standard_ShortReal, theUnits: Standard_ShortReal) -> None: ...
...
class Graphic3d_CLight(Standard_Transient):
	...
	def Attenuation(self, theConstAttenuation: float, theLinearAttenuation: float) -> None: ...
	def Color(self) -> Quantity_Color: ...
	def Concentration(self) -> Standard_ShortReal: ...
	def ConstAttenuation(self) -> Standard_ShortReal: ...
	def Direction(self) -> gp_Dir: ...
	def Direction(self, theVx: float, theVy: float, theVz: float) -> None: ...
	...
	def Position(self, theX: float, theY: float, theZ: float) -> None: ...
...
class Graphic3d_Camera(Standard_Transient):
	...
	def ZFar(self) -> float: ...
	def ZFitAll(self, theScaleFactor: float, theMinMax: Bnd_Box, theGraphicBB: Bnd_Box, theZNear: float, theZFar: float) -> False: ...
...
class Graphic3d_Group(Standard_Transient):
	...
	def MinMaxValues(self, theXMin: float, theYMin: float, theZMin: float, theXMax: float, theYMax: float, theZMax: float) -> None: ...
...
class Graphic3d_Layer(Standard_Transient):
	...
	def Remove(self, theStruct: Graphic3d_CStructure, thePriority: int, isForChangePriority: Optional[bool]) -> False: ...
...
class Graphic3d_MarkerImage(Standard_Transient):
	...
	def GetTextureSize(self, theWidth: int, theHeight: int) -> None: ...
...
class Graphic3d_Structure(Standard_Transient):
	...
	def Transformation(self) -> Geom_Transformation: ...
	@staticmethod
	def Transforms(self, theTrsf: gp_Trsf, theX: float, theY: float, theZ: float, theNewX: float, theNewY: float, theNewZ: float) -> None: ...
...
class Graphic3d_CView(Graphic3d_DataStructureManager):
	...
	def FBOGetDimensions(self, theFbo: Standard_Transient, theWidth: int, theHeight: int, theWidthMax: int, theHeightMax: int) -> None: ...
