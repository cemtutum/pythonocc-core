...
class AIS:
	@staticmethod
	def ComputeGeomCurve(self, aCurve: Geom_Curve, first1: float, last1: float, FirstPnt1: gp_Pnt, LastPnt1: gp_Pnt, aPlane: Geom_Plane, isOnPlane: bool) -> bool: ...
	@staticmethod
	def ComputeGeometry(self, theEdge: TopoDS_Edge, theCurve: Geom_Curve, theFirstPnt: gp_Pnt, theLastPnt: gp_Pnt) -> bool: ...
	@staticmethod
	def ComputeGeometry(self, theEdge: TopoDS_Edge, theCurve: Geom_Curve, theFirstPnt: gp_Pnt, theLastPnt: gp_Pnt, theIsInfinite: bool) -> bool: ...
	@staticmethod
	def ComputeGeometry(self, theEdge: TopoDS_Edge, theCurve: Geom_Curve, theFirstPnt: gp_Pnt, theLastPnt: gp_Pnt, theExtCurve: Geom_Curve, theIsInfinite: bool, theIsOnPlane: bool, thePlane: Geom_Plane) -> bool: ...
	@staticmethod
	...
	@staticmethod
	def ComputeGeometry(self, theFirstEdge: TopoDS_Edge, theSecondEdge: TopoDS_Edge, theFirstCurve: Geom_Curve, theSecondCurve: Geom_Curve, theFirstPnt1: gp_Pnt, theLastPnt1: gp_Pnt, theFirstPnt2: gp_Pnt, theLastPnt2: gp_Pnt, theIsinfinite1: bool, theIsinfinite2: bool) -> bool: ...
	@staticmethod
	def ComputeGeometry(self, theFirstEdge: TopoDS_Edge, theSecondEdge: TopoDS_Edge, theExtIndex: int, theFirstCurve: Geom_Curve, theSecondCurve: Geom_Curve, theFirstPnt1: gp_Pnt, theLastPnt1: gp_Pnt, theFirstPnt2: gp_Pnt, theLastPnt2: gp_Pnt, theExtCurve: Geom_Curve, theIsinfinite1: bool, theIsinfinite2: bool, thePlane: Geom_Plane) -> bool: ...
	@staticmethod
	def ComputeGeometry(self, aVertex: TopoDS_Vertex, point: gp_Pnt, aPlane: Geom_Plane, isOnPlane: bool) -> bool: ...
	@staticmethod
	...
	@staticmethod
	def GetPlaneFromFace(self, aFace: TopoDS_Face, aPlane: gp_Pln, aSurf: Geom_Surface, aSurfType: AIS_KindOfSurface, Offset: float) -> bool: ...
	@staticmethod
	...
	@staticmethod
	def InitFaceLength(self, aFace: TopoDS_Face, aPlane: gp_Pln, aSurface: Geom_Surface, aSurfaceType: AIS_KindOfSurface, anOffset: float) -> None: ...
	@staticmethod
	...
	@staticmethod
	def NearestApex(self, elips: gp_Elips, pApex: gp_Pnt, nApex: gp_Pnt, fpara: float, lpara: float, IsInDomain: bool) -> gp_Pnt: ...
	@staticmethod
...
class AIS_GraphicTool:
	...
	@staticmethod
	def GetLineAtt(self, aDrawer: Prs3d_Drawer, TheTypeOfAttributes: AIS_TypeOfAttribute, aCol: Quantity_NameOfColor, aWidth: float, aTyp: Aspect_TypeOfLine) -> None: ...
	@staticmethod
...
class AIS_InteractiveContext(Standard_Transient):
	...
	def PolygonOffsets(self, anObj: AIS_InteractiveObject, aMode: int, aFactor: Standard_ShortReal, aUnits: Standard_ShortReal) -> None: ...
...
class AIS_Circle(AIS_InteractiveObject):
	...
	def Parameters(self, theU1: float, theU2: float) -> None: ...
...
class AIS_ColorScale(AIS_InteractiveObject):
	...
	def GetPosition(self, theX: float, theY: float) -> None: ...
	def GetRange(self, theMin: float, theMax: float) -> None: ...
	def GetSize(self, theBreadth: int, theHeight: int) -> None: ...
	...
	def HueRange(self, theMinAngle: float, theMaxAngle: float) -> None: ...
	...
	def TextSize(self, theText: TCollection_ExtendedString, theHeight: int, theWidth: int, theAscent: int, theDescent: int) -> None: ...
