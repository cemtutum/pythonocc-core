...
class BOPTools_AlgoTools:
	...
	@staticmethod
	def ComputeTolerance(self, theFace: TopoDS_Face, theEdge: TopoDS_Edge, theMaxDist: float, theMaxPar: float) -> bool: ...
	@staticmethod
...
class BOPTools_AlgoTools2D:
	...
	@staticmethod
	def CurveOnSurface(self, aE: TopoDS_Edge, aF: TopoDS_Face, aC: Geom2d_Curve, aToler: float, theContext: Optional[IntTools_Context]) -> None: ...
	@staticmethod
	def CurveOnSurface(self, aE: TopoDS_Edge, aF: TopoDS_Face, aC: Geom2d_Curve, aFirst: float, aLast: float, aToler: float, theContext: Optional[IntTools_Context]) -> None: ...
	@staticmethod
	def EdgeTangent(self, anE: TopoDS_Edge, aT: float, Tau: gp_Vec) -> bool: ...
	@staticmethod
	def HasCurveOnSurface(self, aE: TopoDS_Edge, aF: TopoDS_Face, aC: Geom2d_Curve, aFirst: float, aLast: float, aToler: float) -> bool: ...
	@staticmethod
	...
	@staticmethod
	def IsEdgeIsoline(self, theE: TopoDS_Edge, theF: TopoDS_Face, isTheUIso: bool, isTheVIso: bool) -> None: ...
	@staticmethod
	def Make2D(self, aE: TopoDS_Edge, aF: TopoDS_Face, aC: Geom2d_Curve, aFirst: float, aLast: float, aToler: float, theContext: Optional[IntTools_Context]) -> None: ...
	@staticmethod
	def MakePCurveOnFace(self, aF: TopoDS_Face, C3D: Geom_Curve, aC: Geom2d_Curve, aToler: float, theContext: Optional[IntTools_Context]) -> None: ...
	@staticmethod
	def MakePCurveOnFace(self, aF: TopoDS_Face, C3D: Geom_Curve, aT1: float, aT2: float, aC: Geom2d_Curve, aToler: float, theContext: Optional[IntTools_Context]) -> None: ...
	@staticmethod
	def PointOnSurface(self, aE: TopoDS_Edge, aF: TopoDS_Face, aT: float, U: float, V: float, theContext: Optional[IntTools_Context]) -> None: ...
