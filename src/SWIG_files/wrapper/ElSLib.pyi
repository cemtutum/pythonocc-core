...
class ElSLib:
	...
	@staticmethod
	def ConeParameters(self, Pos: gp_Ax3, Radius: float, SAngle: float, P: gp_Pnt, U: float, V: float) -> None: ...
	@staticmethod
	...
	@staticmethod
	def CylinderParameters(self, Pos: gp_Ax3, Radius: float, P: gp_Pnt, U: float, V: float) -> None: ...
	@staticmethod
	...
	@staticmethod
	def Parameters(self, Pl: gp_Pln, P: gp_Pnt, U: float, V: float) -> None: ...
	@staticmethod
	def Parameters(self, C: gp_Cylinder, P: gp_Pnt, U: float, V: float) -> None: ...
	@staticmethod
	def Parameters(self, C: gp_Cone, P: gp_Pnt, U: float, V: float) -> None: ...
	@staticmethod
	def Parameters(self, S: gp_Sphere, P: gp_Pnt, U: float, V: float) -> None: ...
	@staticmethod
	def Parameters(self, T: gp_Torus, P: gp_Pnt, U: float, V: float) -> None: ...
	@staticmethod
	...
	@staticmethod
	def PlaneParameters(self, Pos: gp_Ax3, P: gp_Pnt, U: float, V: float) -> None: ...
	@staticmethod
	...
	@staticmethod
	def SphereParameters(self, Pos: gp_Ax3, Radius: float, P: gp_Pnt, U: float, V: float) -> None: ...
	@staticmethod
	...
	@staticmethod
	def TorusParameters(self, Pos: gp_Ax3, MajorRadius: float, MinorRadius: float, P: gp_Pnt, U: float, V: float) -> None: ...
	@staticmethod
