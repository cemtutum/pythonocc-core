...
class BRepTools:
	...
	@staticmethod
	def DetectClosedness(self, theFace: TopoDS_Face, theUclosed: bool, theVclosed: bool) -> None: ...
	@staticmethod
	...
	@staticmethod
	def UVBounds(self, F: TopoDS_Face, UMin: float, UMax: float, VMin: float, VMax: float) -> None: ...
	@staticmethod
	def UVBounds(self, F: TopoDS_Face, W: TopoDS_Wire, UMin: float, UMax: float, VMin: float, VMax: float) -> None: ...
	@staticmethod
	def UVBounds(self, F: TopoDS_Face, E: TopoDS_Edge, UMin: float, UMax: float, VMin: float, VMax: float) -> None: ...
	@staticmethod
