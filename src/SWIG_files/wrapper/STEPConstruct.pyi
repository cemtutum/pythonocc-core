...
class STEPConstruct_Styles(STEPConstruct_Tool):
	...
	def GetColors(self, style: StepVisual_StyledItem, SurfCol: StepVisual_Colour, BoundCol: StepVisual_Colour, CurveCol: StepVisual_Colour, IsComponent: bool) -> bool: ...
	def Init(self, WS: XSControl_WorkSession) -> bool: ...
...
class STEPConstruct_ValidationProps(STEPConstruct_Tool):
	...
	def GetPropReal(self, item: StepRepr_RepresentationItem, Val: float, isArea: bool) -> bool: ...
