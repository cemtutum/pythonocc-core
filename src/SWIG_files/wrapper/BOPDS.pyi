...
class BOPDS_IndexRange:
	...
	def Dump(self) -> None: ...
	def First(self) -> int: ...
	def Indices(self, theI1: int, theI2: int) -> None: ...
	def Last(self) -> int: ...
...
class BOPDS_Iterator:
	...
	def Value(self, theIndex1: int, theIndex2: int) -> None: ...

class BOPDS_Pair:
	def __init__(self) -> None: ...
	def __init__(self, theIndex1: int, theIndex2: int) -> None: ...
	def HashCode(self, theUpperBound: int) -> int: ...
	def Indices(self, theIndex1: int, theIndex2: int) -> None: ...
...
class BOPDS_Pave:
	def __init__(self) -> None: ...
	def Contents(self, theIndex: int, theParameter: float) -> None: ...
	def Dump(self) -> None: ...
	def Index(self) -> int: ...
...
class BOPDS_PaveBlock(Standard_Transient):
	...
	def Range(self, theT1: float, theT2: float) -> None: ...
	...
	def ShrunkData(self, theTS1: float, theTS2: float, theBox: Bnd_Box, theIsSplittable: bool) -> None: ...
...
class BOPDS_InterfVF(BOPDS_Interf):
	...
	def UV(self, theU: float, theV: float) -> None: ...
