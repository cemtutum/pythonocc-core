...
class BRepFeat:
	...
	@staticmethod
	def ParametricMinMax(self, S: TopoDS_Shape, C: Geom_Curve, prmin: float, prmax: float, prbmin: float, prbmax: float, flag: bool, Ori: Optional[bool]) -> None: ...
	@staticmethod
...
class BRepFeat_MakeLinearForm(BRepFeat_RibSlot):
	...
	def Propagate(self, L: TopTools_ListOfShape, F: TopoDS_Face, FPoint: gp_Pnt, LPoint: gp_Pnt, falseside: bool) -> bool: ...
...
class BRepFeat_MakeRevolutionForm(BRepFeat_RibSlot):
	def __init__(self) -> None: ...
	def __init__(self, Sbase: TopoDS_Shape, W: TopoDS_Wire, Plane: Geom_Plane, Axis: gp_Ax1, Height1: float, Height2: float, Fuse: int, Sliding: bool) -> None: ...
	def Add(self, E: TopoDS_Edge, OnFace: TopoDS_Face) -> None: ...
	def Init(self, Sbase: TopoDS_Shape, W: TopoDS_Wire, Plane: Geom_Plane, Axis: gp_Ax1, Height1: float, Height2: float, Fuse: int, Sliding: bool) -> None: ...
	def Perform(self) -> None: ...
	def Propagate(self, L: TopTools_ListOfShape, F: TopoDS_Face, FPoint: gp_Pnt, LPoint: gp_Pnt, falseside: bool) -> bool: ...
