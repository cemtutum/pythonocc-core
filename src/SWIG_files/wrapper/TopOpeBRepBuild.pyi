...
class TopOpeBRepBuild_Builder:
	...
	def GParamOnReference(self, V: TopoDS_Vertex, E: TopoDS_Edge, P: float) -> bool: ...
	...
	def GtraceSPS(self, S: TopoDS_Shape, IS: int) -> bool: ...
	...
	def KPisdisjanalyse(self, ST1: TopAbs_State, ST2: TopAbs_State, I: int, IC1: int, IC2: int) -> None: ...
	...
	def KPiskoleanalyse(self, FT1: TopAbs_State, FT2: TopAbs_State, ST1: TopAbs_State, ST2: TopAbs_State, I: int, I1: int, I2: int) -> None: ...
	def KPiskolesh(self, S: TopoDS_Shape, LS: TopTools_ListOfShape, LF: TopTools_ListOfShape) -> bool: ...
	def KPiskoletge(self) -> int: ...
	def KPiskoletgeanalyse(self, Conf: TopOpeBRepDS_Config, ST1: TopAbs_State, ST2: TopAbs_State, I: int) -> None: ...
...
class TopOpeBRepBuild_GTopo:
	...
	def Index(self, II: int, i1: int, i2: int) -> None: ...
...
class TopOpeBRepBuild_HBuilder(Standard_Transient):
	...
	def DataStructure(self) -> TopOpeBRepDS_HDataStructure: ...
	def EdgeCurveAncestors(self, E: TopoDS_Shape, F1: TopoDS_Shape, F2: TopoDS_Shape, IC: int) -> bool: ...
...
class TopOpeBRepBuild_Builder1(TopOpeBRepBuild_Builder):
	...
	def PerformPieceIn2D(self, aPieceToPerform: TopoDS_Edge, aOriginalEdge: TopoDS_Edge, edgeFace: TopoDS_Face, toFace: TopoDS_Face, G: TopOpeBRepBuild_GTopo, keep: bool) -> None: ...
...
class TopOpeBRepBuild_PaveClassifier(TopOpeBRepBuild_LoopClassifier):
	...
	@staticmethod
	def AdjustCase(self, p1: float, o: TopAbs_Orientation, first: float, period: float, tol: float, cas: int) -> float: ...
...
class TopOpeBRepBuild_WireEdgeSet(TopOpeBRepBuild_ShapeSet):
	...
	@staticmethod
	def IsUVISO(self, E: TopoDS_Edge, F: TopoDS_Face, uiso: bool, viso: bool) -> None: ...
	def MakeNeighboursList(self, E: TopoDS_Shape, V: TopoDS_Shape) -> TopTools_ListOfShape: ...
	def SName(self, S: TopoDS_Shape, sb: Optional[TCollection_AsciiString], sa: Optional[TCollection_AsciiString]) -> TCollection_AsciiString: ...
	def SName(self, S: TopTools_ListOfShape, sb: Optional[TCollection_AsciiString], sa: Optional[TCollection_AsciiString]) -> TCollection_AsciiString: ...
	def SNameori(self, S: TopoDS_Shape, sb: Optional[TCollection_AsciiString], sa: Optional[TCollection_AsciiString]) -> TCollection_AsciiString: ...
