...
class BRepBlend_AppFuncRoot(Approx_SweepFunction):
	...
	def Resolution(self, Index: int, Tol: float, TolU: float, TolV: float) -> None: ...
	def SectionShape(self, NbPoles: int, NbKnots: int, Degree: int) -> None: ...
...
class BRepBlend_AppSurf(AppBlend_Approx):
	...
	def CriteriumWeight(self, W1: float, W2: float, W3: float) -> None: ...
...
class BRepBlend_RstRstConstRad(Blend_RstRstFunction):
	...
	def GetShape(self, NbPoles: int, NbKnots: int, Degree: int, NbPoles2d: int) -> None: ...
	def GetTolerance(self, Tolerance: math_Vector, Tol: float) -> None: ...
	...
	def Resolution(self, IC2d: int, Tol: float, TolU: float, TolV: float) -> None: ...
	def Section(self, Param: float, U: float, V: float, Pdeb: float, Pfin: float, C: gp_Circ) -> None: ...
...
class BRepBlend_RstRstLineBuilder:
	...
	def PerformFirstSection(self, Func: Blend_RstRstFunction, Finv1: Blend_SurfCurvFuncInv, FinvP1: Blend_CurvPointFuncInv, Finv2: Blend_SurfCurvFuncInv, FinvP2: Blend_CurvPointFuncInv, Pdep: float, Pmax: float, Soldep: math_Vector, Tolesp: float, TolGuide: float, RecRst1: bool, RecP1: bool, RecRst2: bool, RecP2: bool, Psol: float, ParSol: math_Vector) -> bool: ...
...
class BRepBlend_SurfRstConstRad(Blend_SurfRstFunction):
	...
	def Resolution(self, IC2d: int, Tol: float, TolU: float, TolV: float) -> None: ...
	def Section(self, Param: float, U: float, V: float, W: float, Pdeb: float, Pfin: float, C: gp_Circ) -> None: ...
	def Section(self, P: Blend_Point, Poles: TColgp_Array1OfPnt, DPoles: TColgp_Array1OfVec, Poles2d: TColgp_Array1OfPnt2d, DPoles2d: TColgp_Array1OfVec2d, Weigths: TColStd_Array1OfReal, DWeigths: TColStd_Array1OfReal) -> bool: ...
	def Section(self, P: Blend_Point, Poles: TColgp_Array1OfPnt, DPoles: TColgp_Array1OfVec, D2Poles: TColgp_Array1OfVec, Poles2d: TColgp_Array1OfPnt2d, DPoles2d: TColgp_Array1OfVec2d, D2Poles2d: TColgp_Array1OfVec2d, Weigths: TColStd_Array1OfReal, DWeigths: TColStd_Array1OfReal, D2Weigths: TColStd_Array1OfReal) -> bool: ...
	def Section(self, P: Blend_Point, Poles: TColgp_Array1OfPnt, Poles2d: TColgp_Array1OfPnt2d, Weigths: TColStd_Array1OfReal) -> None: ...
...
class BRepBlend_SurfRstLineBuilder:
	...
	def ArcToRecadre(self, Sol: math_Vector, PrevIndex: int, pt2d: gp_Pnt2d, lastpt2d: gp_Pnt2d, ponarc: float) -> int: ...
	...
	def PerformFirstSection(self, Func: Blend_SurfRstFunction, Finv: Blend_FuncInv, FinvP: Blend_SurfPointFuncInv, FinvC: Blend_SurfCurvFuncInv, Pdep: float, Pmax: float, Soldep: math_Vector, Tolesp: float, TolGuide: float, RecRst: bool, RecP: bool, RecS: bool, Psol: float, ParSol: math_Vector) -> bool: ...
...
class BRepBlend_Walking:
	...
	def PerformFirstSection(self, F: Blend_Function, FInv: Blend_FuncInv, Pdep: float, Pmax: float, ParDep: math_Vector, Tolesp: float, TolGuide: float, RecOnS1: bool, RecOnS2: bool, Psol: float, ParSol: math_Vector) -> bool: ...
