...
class IFSelect_Activator(Standard_Transient):
	...
	@staticmethod
	def Select(self, command: str, number: int, actor: IFSelect_Activator) -> bool: ...
...
class IFSelect_ShareOutResult:
	...
	def PacketsInDispatch(self, numpack: int, nbpacks: int) -> None: ...
...
class IFSelect_WorkLibrary(Standard_Transient):
	...
	def DumpLevels(self, def_: int, max: int) -> None: ...
