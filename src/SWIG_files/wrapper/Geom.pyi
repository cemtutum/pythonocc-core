...
class Geom_Transformation(Standard_Transient):
	...
	def Transforms(self, theX: float, theY: float, theZ: float) -> None: ...
...
class Geom_Point(Geom_Geometry):
	def Coord(self, X: float, Y: float, Z: float) -> None: ...
...
class Geom_Surface(Geom_Geometry):
	def Bounds(self, U1: float, U2: float, V1: float, V2: float) -> None: ...
	def Continuity(self) -> GeomAbs_Shape: ...
	...
	def TransformParameters(self, U: float, V: float, T: gp_Trsf) -> None: ...
...
class Geom_BSplineCurve(Geom_BoundedCurve):
	...
	def LocateU(self, U: float, ParametricTolerance: float, I1: int, I2: int, WithKnotRepetition: Optional[bool]) -> None: ...
	@staticmethod
	def MaxDegree(self) -> int: ...
	def MovePoint(self, U: float, P: gp_Pnt, Index1: int, Index2: int, FirstModifiedPole: int, LastModifiedPole: int) -> None: ...
	def MovePointAndTangent(self, U: float, P: gp_Pnt, Tangent: gp_Vec, Tolerance: float, StartingCondition: int, EndingCondition: int, ErrorStatus: int) -> None: ...
	...
	def PeriodicNormalization(self, U: float) -> None: ...
	...
	def Resolution(self, Tolerance3D: float, UTolerance: float) -> None: ...
	def Reverse(self) -> None: ...
	def ReversedParameter(self, U: float) -> float: ...
...
class Geom_BSplineSurface(Geom_BoundedSurface):
	...
	def LocateU(self, U: float, ParametricTolerance: float, I1: int, I2: int, WithKnotRepetition: Optional[bool]) -> None: ...
	def LocateV(self, V: float, ParametricTolerance: float, I1: int, I2: int, WithKnotRepetition: Optional[bool]) -> None: ...
	@staticmethod
	def MaxDegree(self) -> int: ...
	def MovePoint(self, U: float, V: float, P: gp_Pnt, UIndex1: int, UIndex2: int, VIndex1: int, VIndex2: int, UFirstIndex: int, ULastIndex: int, VFirstIndex: int, VLastIndex: int) -> None: ...
	def NbUKnots(self) -> int: ...
	def NbUPoles(self) -> int: ...
	def NbVKnots(self) -> int: ...
	def NbVPoles(self) -> int: ...
	def PeriodicNormalization(self, U: float, V: float) -> None: ...
	...
	def Resolution(self, Tolerance3D: float, UTolerance: float, VTolerance: float) -> None: ...
...
class Geom_ConicalSurface(Geom_ElementarySurface):
	...
	def Bounds(self, U1: float, U2: float, V1: float, V2: float) -> None: ...
	def Coefficients(self, A1: float, A2: float, A3: float, B1: float, B2: float, B3: float, C1: float, C2: float, C3: float, D: float) -> None: ...
...
class Geom_Plane(Geom_ElementarySurface):
	...
	def Bounds(self, U1: float, U2: float, V1: float, V2: float) -> None: ...
	def Coefficients(self, A: float, B: float, C: float, D: float) -> None: ...
	def Copy(self) -> Geom_Geometry: ...
	def D0(self, U: float, V: float, P: gp_Pnt) -> None: ...
	def D1(self, U: float, V: float, P: gp_Pnt, D1U: gp_Vec, D1V: gp_Vec) -> None: ...
	def D2(self, U: float, V: float, P: gp_Pnt, D1U: gp_Vec, D1V: gp_Vec, D2U: gp_Vec, D2V: gp_Vec, D2UV: gp_Vec) -> None: ...
