...
class GeomInt:
	@staticmethod
	def AdjustPeriodic(self, thePar: float, theParMin: float, theParMax: float, thePeriod: float, theNewPar: float, theOffset: float, theEps: Optional[float]) -> bool: ...
...
class GeomInt_IntSS:
	...
	@staticmethod
	def BuildPCurves(self, f: float, l: float, Tol: float, S: Geom_Surface, C: Geom_Curve, C2d: Geom2d_Curve) -> None: ...
	...
	@staticmethod
	def TreatRLine(self, theRL: IntPatch_RLine, theHS1: GeomAdaptor_HSurface, theHS2: GeomAdaptor_HSurface, theC3d: Geom_Curve, theC2d1: Geom2d_Curve, theC2d2: Geom2d_Curve, theTolReached: float) -> None: ...
	@staticmethod
...
class GeomInt_LineConstructor:
	...
	def Part(self, I: int, WFirst: float, WLast: float) -> None: ...
