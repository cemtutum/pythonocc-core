...
class BRepFill:
	@staticmethod
	def Axe(self, Spine: TopoDS_Shape, Profile: TopoDS_Wire, AxeProf: gp_Ax3, ProfOnSpine: bool, Tol: float) -> None: ...
	@staticmethod
...
class BRepFill_ComputeCLine:
	...
	def Parameters(self, Index: int, firstp: float, lastp: float) -> None: ...
...
class BRepFill_LocationLaw(Standard_Transient):
	...
	def CurvilinearBounds(self, Index: int, First: float, Last: float) -> None: ...
	...
	def NbLaw(self) -> int: ...
	def Parameter(self, Abscissa: float, Index: int, Param: float) -> None: ...
