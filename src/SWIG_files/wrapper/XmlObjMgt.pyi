...
class XmlObjMgt:
	...
	@staticmethod
	def GetInteger(self, theString: str, theValue: int) -> bool: ...
	@staticmethod
	def GetReal(self, theString: str, theValue: float) -> bool: ...
	@staticmethod
	def GetReal(self, theString: XmlObjMgt_DOMString, theValue: float) -> bool: ...
	@staticmethod
