...
class StdPrs_HLRToolShape:
	def Hidden(self, TheEdge: BRepAdaptor_Curve, U1: float, U2: float) -> None: ...
	...
	def Visible(self, TheEdge: BRepAdaptor_Curve, U1: float, U2: float) -> None: ...
...
class StdPrs_Isolines(Prs3d_Root):
	...
	@staticmethod
	def UVIsoParameters(self, theFace: TopoDS_Face, theNbIsoU: int, theNbIsoV: int, theUVLimit: float, theUIsoParams: TColStd_SequenceOfReal, theVIsoParams: TColStd_SequenceOfReal, theUmin: float, theUmax: float, theVmin: float, theVmax: float) -> None: ...
...
class StdPrs_ToolPoint:
	@staticmethod
	def Coord(self, aPoint: Geom_Point, X: float, Y: float, Z: float) -> None: ...
...
class StdPrs_ToolVertex:
	@staticmethod
	def Coord(self, aPoint: TopoDS_Vertex, X: float, Y: float, Z: float) -> None: ...
