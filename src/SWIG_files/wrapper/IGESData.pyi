...
class IGESData_DirPart:
	...
	def Values(self, i1: int, i2: int, i3: int, i4: int, i5: int, i6: int, i7: int, i8: int, i9: int, i19: int, i11: int, i12: int, i13: int, i14: int, i15: int, i16: int, i17: int, res1: str, res2: str, label: str, subscript: str) -> None: ...
...
class IGESData_IGESReaderData(Interface_FileReaderData):
	...
	def DirValues(self, num: int, i1: int, i2: int, i3: int, i4: int, i5: int, i6: int, i7: int, i8: int, i9: int, i10: int, i11: int, i12: int, i13: int, i14: int, i15: int, i16: int, i17: int, res1: str, res2: str, label: str, subs: str) -> None: ...
...
class IGESData_ParamReader:
	...
	def ReadBoolean(self, PC: IGESData_ParamCursor, amsg: Message_Msg, val: bool, exact: Optional[bool]) -> bool: ...
	def ReadBoolean(self, PC: IGESData_ParamCursor, mess: str, val: bool, exact: Optional[bool]) -> bool: ...
