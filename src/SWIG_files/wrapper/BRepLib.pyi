...
class BRepLib:
	...
	@staticmethod
	def BuildPCurveForEdgeOnPlane(self, theE: TopoDS_Edge, theF: TopoDS_Face, aC2D: Geom2d_Curve, bToUpdate: bool) -> None: ...
	@staticmethod
	...
	@staticmethod
	def FindValidRange(self, theCurve: Adaptor3d_Curve, theTolE: float, theParV1: float, thePntV1: gp_Pnt, theTolV1: float, theParV2: float, thePntV2: gp_Pnt, theTolV2: float, theFirst: float, theLast: float) -> bool: ...
	@staticmethod
	def FindValidRange(self, theEdge: TopoDS_Edge, theFirst: float, theLast: float) -> bool: ...
	@staticmethod
	...
	@staticmethod
	def SameParameter(self, theEdge: TopoDS_Edge, theTolerance: float, theNewTol: float, IsUseOldEdge: bool) -> TopoDS_Edge: ...
	@staticmethod
...
class BRepLib_MakeFace(BRepLib_MakeShape):
	...
	@staticmethod
	def IsDegenerated(self, theCurve: Geom_Curve, theMaxTol: float, theActTol: float) -> bool: ...
