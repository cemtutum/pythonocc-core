...
class BRepClass3d_SolidExplorer:
	...
	@staticmethod
	def FindAPointInTheFace(self, F: TopoDS_Face, P: gp_Pnt, Param: float) -> bool: ...
	@staticmethod
	def FindAPointInTheFace(self, F: TopoDS_Face, P: gp_Pnt, u: float, v: float, Param: float) -> bool: ...
	@staticmethod
	def FindAPointInTheFace(self, F: TopoDS_Face, P: gp_Pnt, u: float, v: float, Param: float, theVecD1U: gp_Vec, theVecD1V: gp_Vec) -> bool: ...
	@staticmethod
	def FindAPointInTheFace(self, F: TopoDS_Face, P: gp_Pnt, u: float, v: float) -> bool: ...
	@staticmethod
	def FindAPointInTheFace(self, F: TopoDS_Face, P: gp_Pnt) -> bool: ...
	@staticmethod
	def FindAPointInTheFace(self, F: TopoDS_Face, u: float, v: float) -> bool: ...
	...
	def OtherSegment(self, P: gp_Pnt, L: gp_Lin, Par: float) -> int: ...
	def PointInTheFace(self, F: TopoDS_Face, P: gp_Pnt, u: float, v: float, Param: float, Index: int) -> bool: ...
	def PointInTheFace(self, F: TopoDS_Face, P: gp_Pnt, u: float, v: float, Param: float, Index: int, surf: BRepAdaptor_HSurface, u1: float, v1: float, u2: float, v2: float) -> bool: ...
	def PointInTheFace(self, F: TopoDS_Face, P: gp_Pnt, u: float, v: float, Param: float, Index: int, surf: BRepAdaptor_HSurface, u1: float, v1: float, u2: float, v2: float, theVecD1U: gp_Vec, theVecD1V: gp_Vec) -> bool: ...
	def Reject(self, P: gp_Pnt) -> bool: ...
	def RejectFace(self, L: gp_Lin) -> bool: ...
	def RejectShell(self, L: gp_Lin) -> bool: ...
	def Segment(self, P: gp_Pnt, L: gp_Lin, Par: float) -> int: ...
