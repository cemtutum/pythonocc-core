...
class Extrema_ELPCOfLocateExtPC:
	...
	def SquareDistance(self, N: int) -> float: ...
	def TrimmedSquareDistances(self, dist1: float, dist2: float, P1: gp_Pnt, P2: gp_Pnt) -> None: ...
...
class Extrema_ELPCOfLocateExtPC2d:
	...
	def SquareDistance(self, N: int) -> float: ...
	def TrimmedSquareDistances(self, dist1: float, dist2: float, P1: gp_Pnt2d, P2: gp_Pnt2d) -> None: ...
...
class Extrema_ExtCC:
	...
	def SquareDistance(self, N: Optional[int]) -> float: ...
	def TrimmedSquareDistances(self, dist11: float, distP12: float, distP21: float, distP22: float, P11: gp_Pnt, P12: gp_Pnt, P21: gp_Pnt, P22: gp_Pnt) -> None: ...
...
class Extrema_ExtCC2d:
	...
	def SetSingleSolutionFlag(self, theSingleSolutionFlag: bool) -> None: ...
	def SquareDistance(self, N: Optional[int]) -> float: ...
	def TrimmedSquareDistances(self, dist11: float, distP12: float, distP21: float, distP22: float, P11: gp_Pnt2d, P12: gp_Pnt2d, P21: gp_Pnt2d, P22: gp_Pnt2d) -> None: ...
...
class Extrema_ExtPS:
	...
	def SquareDistance(self, N: int) -> float: ...
	def TrimmedSquareDistances(self, dUfVf: float, dUfVl: float, dUlVf: float, dUlVl: float, PUfVf: gp_Pnt, PUfVl: gp_Pnt, PUlVf: gp_Pnt, PUlVl: gp_Pnt) -> None: ...
...
class Extrema_GlobOptFuncCS(math_MultipleVarFunctionWithHessian):
	...
	def NbVariables(self) -> int: ...
	def Value(self, theX: math_Vector, theF: float) -> bool: ...
	def Values(self, theX: math_Vector, theF: float, theG: math_Vector) -> bool: ...
	def Values(self, theX: math_Vector, theF: float, theG: math_Vector, theH: math_Matrix) -> bool: ...
...
class Extrema_POnSurf:
	...
	def Parameter(self, U: float, V: float) -> None: ...
...
class Extrema_POnSurfParams(Extrema_POnSurf):
	...
	def GetIndices(self, theIndexU: int, theIndexV: int) -> None: ...
