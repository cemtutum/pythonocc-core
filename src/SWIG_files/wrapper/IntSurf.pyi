...
class IntSurf:
	...
	@staticmethod
	def SetPeriod(self, theFirstSurf: Adaptor3d_HSurface, theSecondSurf: Adaptor3d_HSurface, theArrOfPeriod[4]: float) -> None: ...
...
class IntSurf_InteriorPointTool:
	...
	@staticmethod
	def Value2d(self, PStart: IntSurf_InteriorPoint, U: float, V: float) -> None: ...
	@staticmethod
...
class IntSurf_PathPoint:
	...
	def Parameters(self, Index: int, U: float, V: float) -> None: ...
	...
	def Value(self) -> gp_Pnt: ...
	def Value2d(self, U: float, V: float) -> None: ...
...
class IntSurf_PathPointTool:
	...
	@staticmethod
	def Parameters(self, PStart: IntSurf_PathPoint, Mult: int, U: float, V: float) -> None: ...
	@staticmethod
	def Value2d(self, PStart: IntSurf_PathPoint, U: float, V: float) -> None: ...
	@staticmethod
...
class IntSurf_PntOn2S:
	...
	def ParametersOnSurface(self, OnFirst: bool, U: float, V: float) -> None: ...
...
class IntSurf_Quadric:
	...
	def Parameters(self, P: gp_Pnt, U: float, V: float) -> None: ...
	...
	def ValAndGrad(self, P: gp_Pnt, Dist: float, Grad: gp_Vec) -> None: ...
...
class IntSurf_QuadricTool:
	...
	@staticmethod
	def ValueAndGradient(self, Quad: IntSurf_Quadric, X: float, Y: float, Z: float, Val: float, Grad: gp_Vec) -> None: ...
