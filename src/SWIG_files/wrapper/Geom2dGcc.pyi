...
class Geom2dGcc_Circ2d2TanOn:
	def CenterOn3(self, Index: int, ParArg: float, PntSol: gp_Pnt2d) -> None: ...
	...
	def Tangency1(self, Index: int, ParSol: float, ParArg: float, PntSol: gp_Pnt2d) -> None: ...
	def Tangency2(self, Index: int, ParSol: float, ParArg: float, PntSol: gp_Pnt2d) -> None: ...
...
class Geom2dGcc_Circ2d2TanOnIter:
	def CenterOn3(self, ParArg: float, PntSol: gp_Pnt2d) -> None: ...
	...
	def Tangency1(self, ParSol: float, ParArg: float, PntSol: gp_Pnt2d) -> None: ...
	def Tangency2(self, ParSol: float, ParArg: float, PntSol: gp_Pnt2d) -> None: ...
...
class Geom2dGcc_Circ2d3Tan:
	...
	def Tangency1(self, Index: int, ParSol: float, ParArg: float, PntSol: gp_Pnt2d) -> None: ...
	def Tangency2(self, Index: int, ParSol: float, ParArg: float, PntSol: gp_Pnt2d) -> None: ...
	def Tangency3(self, Index: int, ParSol: float, ParArg: float, PntSol: gp_Pnt2d) -> None: ...
	def ThisSolution(self, Index: int) -> gp_Circ2d: ...
...
class Geom2dGcc_Circ2d3TanIter:
	...
	def Tangency1(self, ParSol: float, ParArg: float, PntSol: gp_Pnt2d) -> None: ...
	def Tangency2(self, ParSol: float, ParArg: float, PntSol: gp_Pnt2d) -> None: ...
	def Tangency3(self, ParSol: float, ParArg: float, PntSol: gp_Pnt2d) -> None: ...
	def ThisSolution(self) -> gp_Circ2d: ...
...
class Geom2dGcc_Lin2dTanObl:
	...
	def Intersection2(self, Index: int, ParSol: float, ParArg: float, PntSol: gp_Pnt2d) -> None: ...
	def IsDone(self) -> bool: ...
	def NbSolutions(self) -> int: ...
	def Tangency1(self, Index: int, ParSol: float, ParArg: float, PntSol: gp_Pnt2d) -> None: ...
	def ThisSolution(self, Index: int) -> gp_Lin2d: ...
...
class Geom2dGcc_Lin2dTanOblIter:
	...
	def Intersection2(self, ParSol: float, ParArg: float, PntSol: gp_Pnt2d) -> None: ...
	def IsDone(self) -> bool: ...
