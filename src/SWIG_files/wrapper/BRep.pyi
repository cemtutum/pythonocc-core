...
class BRep_Tool:
	...
	@staticmethod
	def Curve(self, E: TopoDS_Edge, L: TopLoc_Location, First: float, Last: float) -> Geom_Curve: ...
	@staticmethod
	def Curve(self, E: TopoDS_Edge, First: float, Last: float) -> Geom_Curve: ...
	@staticmethod
	def CurveOnPlane(self, E: TopoDS_Edge, S: Geom_Surface, L: TopLoc_Location, First: float, Last: float) -> Geom2d_Curve: ...
	@staticmethod
	def CurveOnSurface(self, E: TopoDS_Edge, F: TopoDS_Face, First: float, Last: float, theIsStored: Optional[bool]) -> Geom2d_Curve: ...
	@staticmethod
	def CurveOnSurface(self, E: TopoDS_Edge, S: Geom_Surface, L: TopLoc_Location, First: float, Last: float, theIsStored: Optional[bool]) -> Geom2d_Curve: ...
	@staticmethod
	def CurveOnSurface(self, E: TopoDS_Edge, C: Geom2d_Curve, S: Geom_Surface, L: TopLoc_Location, First: float, Last: float) -> None: ...
	@staticmethod
	def CurveOnSurface(self, E: TopoDS_Edge, C: Geom2d_Curve, S: Geom_Surface, L: TopLoc_Location, First: float, Last: float, Index: int) -> None: ...
	@staticmethod
	...
	@staticmethod
	def Range(self, E: TopoDS_Edge, First: float, Last: float) -> None: ...
	@staticmethod
	def Range(self, E: TopoDS_Edge, S: Geom_Surface, L: TopLoc_Location, First: float, Last: float) -> None: ...
	@staticmethod
	def Range(self, E: TopoDS_Edge, F: TopoDS_Face, First: float, Last: float) -> None: ...
...
class BRep_GCurve(BRep_CurveRepresentation):
	...
	def Range(self, First: float, Last: float) -> None: ...
