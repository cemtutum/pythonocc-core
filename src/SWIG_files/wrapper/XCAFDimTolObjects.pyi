...
class XCAFDimTolObjects_DatumObject(Standard_Transient):
	...
	def GetModifierWithValue(self, theModifier: XCAFDimTolObjects_DatumModifWithValue, theValue: float) -> None: ...
...
class XCAFDimTolObjects_DimensionObject(Standard_Transient):
	...
	def GetNbOfDecimalPlaces(self, theL: int, theR: int) -> None: ...
