...
class GeomFill:
	...
	@staticmethod
	def GetShape(self, MaxAng: float, NbPoles: int, NbKnots: int, Degree: int, TypeConv: Convert_ParameterisationType) -> None: ...
	@staticmethod
...
class GeomFill_Boundary(Standard_Transient):
	def Bounds(self, First: float, Last: float) -> None: ...
...
class GeomFill_LocFunction:
	...
	def DN(self, Param: float, First: float, Last: float, Order: int, Result: float, Ier: int) -> None: ...
...
class GeomFill_LocationLaw(Standard_Transient):
	...
	def GetDomain(self, First: float, Last: float) -> None: ...
	def GetInterval(self, First: float, Last: float) -> None: ...
...
class GeomFill_PlanFunc(math_FunctionWithDerivative):
	...
	def D2(self, X: float, F: float, D1: float, D2: float) -> None: ...
	def D2E(self, X: float, DP: gp_Vec, D2P: gp_Vec, DV: gp_Vec, D2V: gp_Vec, DFDT: float, D2FDT2: float, D2FDTDX: float) -> None: ...
	def DEDT(self, X: float, DP: gp_Vec, DV: gp_Vec, DF: float) -> None: ...
...
class GeomFill_Sweep:
	...
	def ErrorOnRestriction(self, IsFirst: bool, UError: float, VError: float) -> None: ...
	def ErrorOnSurface(self) -> float: ...
	def ErrorOnTrace(self, IndexOfTrace: int, UError: float, VError: float) -> None: ...
	def ExchangeUV(self) -> bool: ...
	def IsDone(self) -> bool: ...
...
class GeomFill_LocationGuide(GeomFill_LocationLaw):
	...
	def Set(self, Section: GeomFill_SectionLaw, rotat: bool, SFirst: float, SLast: float, PrecAngle: float, LastAngle: float) -> None: ...
	def SetCurve(self, C: Adaptor3d_HCurve) -> None: ...
	def SetInterval(self, First: float, Last: float) -> None: ...
