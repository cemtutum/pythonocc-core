...
class GProp_GProps:
	...
	def StaticMoments(self, Ix: float, Iy: float, Iz: float) -> None: ...
...
class GProp_PrincipalProps:
	...
	def Moments(self, Ixx: float, Iyy: float, Izz: float) -> None: ...
	def RadiusOfGyration(self, Rxx: float, Ryy: float, Rzz: float) -> None: ...
...
class GProp_PGProps(GProp_GProps):
	...
	@staticmethod
	def Barycentre(self, Pnts: TColgp_Array1OfPnt, Density: TColStd_Array1OfReal, Mass: float, G: gp_Pnt) -> None: ...
	@staticmethod
	def Barycentre(self, Pnts: TColgp_Array2OfPnt, Density: TColStd_Array2OfReal, Mass: float, G: gp_Pnt) -> None: ...
