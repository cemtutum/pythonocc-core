...
class IntPolyh_Intersection:
	def GetLinePoint(self, IndexLine: int, IndexPoint: int, x: float, y: float, z: float, u1: float, v1: float, u2: float, v2: float, incidence: float) -> None: ...
	def GetTangentZonePoint(self, IndexLine: int, IndexPoint: int, x: float, y: float, z: float, u1: float, v1: float, u2: float, v2: float) -> None: ...
...
class IntPolyh_Tools:
	...
	@staticmethod
	def IsEnlargePossible(self, theSurf: Adaptor3d_HSurface, theUEnlarge: bool, theVEnlarge: bool) -> None: ...
	@staticmethod
