...
class GccAna_Circ2d2TanOn:
	def CenterOn3(self, Index: int, ParArg: float, PntArg: gp_Pnt2d) -> None: ...
...
class GccAna_Lin2dBisec:
	...
	def Intersection1(self, Index: int, ParSol: float, ParArg: float, PntSol: gp_Pnt2d) -> None: ...
...
class GccAna_Lin2dTanPar:
	...
	def IsDone(self) -> bool: ...
	def NbSolutions(self) -> int: ...
	def Tangency1(self, Index: int, ParSol: float, ParArg: float, Pnt: gp_Pnt2d) -> None: ...
	def ThisSolution(self, Index: int) -> gp_Lin2d: ...
	def WhichQualifier(self, Index: int, Qualif1: GccEnt_Position) -> None: ...
