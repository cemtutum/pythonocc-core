...
class gp_Circ2d:
	...
	def Coefficients(self, A: float, B: float, C: float, D: float, E: float, F: float) -> None: ...
...
class gp_Dir:
	...
	def Coord(self, Xv: float, Yv: float, Zv: float) -> None: ...
...
class gp_Dir2d:
	...
	def Coord(self, Index: int) -> float: ...
	def Coord(self, Xv: float, Yv: float) -> None: ...
...
class gp_GTrsf:
	...
	def Transforms(self, X: float, Y: float, Z: float) -> None: ...
...
class gp_GTrsf2d:
	...
	def Transforms(self, X: float, Y: float) -> None: ...
...
class gp_Lin2d:
	...
	def Coefficients(self, A: float, B: float, C: float) -> None: ...
	def Contains(self, P: gp_Pnt2d, LinearTolerance: float) -> bool: ...
	def Direction(self) -> gp_Dir2d: ...
	def Distance(self, P: gp_Pnt2d) -> float: ...
...
class gp_Pnt:
	...
	def Coord(self, Index: int) -> float: ...
	def Coord(self, Xp: float, Yp: float, Zp: float) -> None: ...
...
class gp_Pnt2d:
	...
	def Coord(self, Index: int) -> float: ...
	def Coord(self, Xp: float, Yp: float) -> None: ...
...
class gp_Quaternion:
	...
	def GetEulerAngles(self, theOrder: gp_EulerSequence, theAlpha: float, theBeta: float, theGamma: float) -> None: ...
	def GetMatrix(self) -> gp_Mat: ...
	def GetRotationAngle(self) -> float: ...
	def GetVectorAndAngle(self, theAxis: gp_Vec, theAngle: float) -> None: ...
	def Invert(self) -> None: ...
...
class gp_XY:
	...
	def Coord(self, Index: int) -> float: ...
	def Coord(self, X: float, Y: float) -> None: ...
