...
class Aspect_Grid(Standard_Transient):
	...
	def Compute(self, X: float, Y: float, gridX: float, gridY: float) -> None: ...
	def Deactivate(self) -> None: ...
	def Display(self) -> None: ...
	def DrawMode(self) -> Aspect_GridDrawMode: ...
	def Erase(self) -> None: ...
	def Hit(self, X: float, Y: float, gridX: float, gridY: float) -> None: ...
	def Init(self) -> None: ...
...
class Aspect_Window(Standard_Transient):
	...
	def Position(self, X1: int, Y1: int, X2: int, Y2: int) -> None: ...
