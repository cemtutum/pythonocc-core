...
class ChFi3d_Builder:
	...
	def Contains(self, E: TopoDS_Edge, IndexInSpine: int) -> int: ...
	...
	def SplitKPart(self, Data: ChFiDS_SurfData, SetData: ChFiDS_SequenceOfSurfData, Spine: ChFiDS_Spine, Iedge: int, S1: Adaptor3d_HSurface, I1: Adaptor3d_TopolTool, S2: Adaptor3d_HSurface, I2: Adaptor3d_TopolTool, Intf: bool, Intl: bool) -> bool: ...
...
class ChFi3d_ChBuilder(ChFi3d_Builder):
	...
	def Dists(self, IC: int, Dis1: float, Dis2: float) -> None: ...
	def GetDist(self, IC: int, Dis: float) -> None: ...
	def GetDistAngle(self, IC: int, Dis: float, Angle: float) -> None: ...
	def IsChamfer(self, IC: int) -> ChFiDS_ChamfMethod: ...
	def Mode(self) -> ChFiDS_ChamfMode: ...
	def NbSurf(self, IC: int) -> int: ...
	def PerformSurf(self, Data: ChFiDS_SequenceOfSurfData, Guide: ChFiDS_HElSpine, Spine: ChFiDS_Spine, Choix: int, S1: BRepAdaptor_HSurface, I1: Adaptor3d_TopolTool, S2: BRepAdaptor_HSurface, I2: Adaptor3d_TopolTool, MaxStep: float, Fleche: float, TolGuide: float, First: float, Last: float, Inside: bool, Appro: bool, Forward: bool, RecOnS1: bool, RecOnS2: bool, Soldep: math_Vector, Intf: int, Intl: int) -> bool: ...
	def PerformSurf(self, Data: ChFiDS_SequenceOfSurfData, Guide: ChFiDS_HElSpine, Spine: ChFiDS_Spine, Choix: int, S1: BRepAdaptor_HSurface, I1: Adaptor3d_TopolTool, PC1: BRepAdaptor_HCurve2d, Sref1: BRepAdaptor_HSurface, PCref1: BRepAdaptor_HCurve2d, Decroch1: bool, S2: BRepAdaptor_HSurface, I2: Adaptor3d_TopolTool, Or2: TopAbs_Orientation, MaxStep: float, Fleche: float, TolGuide: float, First: float, Last: float, Inside: bool, Appro: bool, Forward: bool, RecP: bool, RecS: bool, RecRst: bool, Soldep: math_Vector) -> None: ...
	def PerformSurf(self, Data: ChFiDS_SequenceOfSurfData, Guide: ChFiDS_HElSpine, Spine: ChFiDS_Spine, Choix: int, S1: BRepAdaptor_HSurface, I1: Adaptor3d_TopolTool, Or1: TopAbs_Orientation, S2: BRepAdaptor_HSurface, I2: Adaptor3d_TopolTool, PC2: BRepAdaptor_HCurve2d, Sref2: BRepAdaptor_HSurface, PCref2: BRepAdaptor_HCurve2d, Decroch2: bool, MaxStep: float, Fleche: float, TolGuide: float, First: float, Last: float, Inside: bool, Appro: bool, Forward: bool, RecP: bool, RecS: bool, RecRst: bool, Soldep: math_Vector) -> None: ...
	def PerformSurf(self, Data: ChFiDS_SequenceOfSurfData, Guide: ChFiDS_HElSpine, Spine: ChFiDS_Spine, Choix: int, S1: BRepAdaptor_HSurface, I1: Adaptor3d_TopolTool, PC1: BRepAdaptor_HCurve2d, Sref1: BRepAdaptor_HSurface, PCref1: BRepAdaptor_HCurve2d, Decroch1: bool, Or1: TopAbs_Orientation, S2: BRepAdaptor_HSurface, I2: Adaptor3d_TopolTool, PC2: BRepAdaptor_HCurve2d, Sref2: BRepAdaptor_HSurface, PCref2: BRepAdaptor_HCurve2d, Decroch2: bool, Or2: TopAbs_Orientation, MaxStep: float, Fleche: float, TolGuide: float, First: float, Last: float, Inside: bool, Appro: bool, Forward: bool, RecP1: bool, RecRst1: bool, RecP2: bool, RecRst2: bool, Soldep: math_Vector) -> None: ...
	...
	def SimulSurf(self, Data: ChFiDS_SurfData, Guide: ChFiDS_HElSpine, Spine: ChFiDS_Spine, Choix: int, S1: BRepAdaptor_HSurface, I1: Adaptor3d_TopolTool, PC1: BRepAdaptor_HCurve2d, Sref1: BRepAdaptor_HSurface, PCref1: BRepAdaptor_HCurve2d, Decroch1: bool, S2: BRepAdaptor_HSurface, I2: Adaptor3d_TopolTool, Or2: TopAbs_Orientation, Fleche: float, TolGuide: float, First: float, Last: float, Inside: bool, Appro: bool, Forward: bool, RecP: bool, RecS: bool, RecRst: bool, Soldep: math_Vector) -> None: ...
	def SimulSurf(self, Data: ChFiDS_SurfData, Guide: ChFiDS_HElSpine, Spine: ChFiDS_Spine, Choix: int, S1: BRepAdaptor_HSurface, I1: Adaptor3d_TopolTool, Or1: TopAbs_Orientation, S2: BRepAdaptor_HSurface, I2: Adaptor3d_TopolTool, PC2: BRepAdaptor_HCurve2d, Sref2: BRepAdaptor_HSurface, PCref2: BRepAdaptor_HCurve2d, Decroch2: bool, Fleche: float, TolGuide: float, First: float, Last: float, Inside: bool, Appro: bool, Forward: bool, RecP: bool, RecS: bool, RecRst: bool, Soldep: math_Vector) -> None: ...
	def SimulSurf(self, Data: ChFiDS_SurfData, Guide: ChFiDS_HElSpine, Spine: ChFiDS_Spine, Choix: int, S1: BRepAdaptor_HSurface, I1: Adaptor3d_TopolTool, PC1: BRepAdaptor_HCurve2d, Sref1: BRepAdaptor_HSurface, PCref1: BRepAdaptor_HCurve2d, Decroch1: bool, Or1: TopAbs_Orientation, S2: BRepAdaptor_HSurface, I2: Adaptor3d_TopolTool, PC2: BRepAdaptor_HCurve2d, Sref2: BRepAdaptor_HSurface, PCref2: BRepAdaptor_HCurve2d, Decroch2: bool, Or2: TopAbs_Orientation, Fleche: float, TolGuide: float, First: float, Last: float, Inside: bool, Appro: bool, Forward: bool, RecP1: bool, RecRst1: bool, RecP2: bool, RecRst2: bool, Soldep: math_Vector) -> None: ...
...
class ChFi3d_FilBuilder(ChFi3d_Builder):
	...
	def GetBounds(self, IC: int, E: TopoDS_Edge, First: float, Last: float) -> bool: ...
