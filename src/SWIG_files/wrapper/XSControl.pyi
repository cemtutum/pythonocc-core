...
class XSControl_Controller(Standard_Transient):
	...
	def ModeWriteBounds(self, modemin: int, modemax: int, shape: Optional[bool]) -> bool: ...
...
class XSControl_Reader:
	...
	def GetStatsTransfer(self, list: TColStd_HSequenceOfTransient, nbMapped: int, nbWithResult: int, nbWithFail: int) -> None: ...
...
class XSControl_Utils:
	...
	def DateValues(self, text: str, yy: int, mm: int, dd: int, hh: int, mn: int, ss: int) -> None: ...
