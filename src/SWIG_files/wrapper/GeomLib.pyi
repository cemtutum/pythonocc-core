...
class GeomLib:
	...
	@staticmethod
	def AxeOfInertia(self, Points: TColgp_Array1OfPnt, Axe: gp_Ax2, IsSingular: bool, Tol: Optional[float]) -> None: ...
	@staticmethod
	def BuildCurve3d(self, Tolerance: float, CurvePtr: Adaptor3d_CurveOnSurface, FirstParameter: float, LastParameter: float, NewCurvePtr: Geom_Curve, MaxDeviation: float, AverageDeviation: float, Continuity: Optional[GeomAbs_Shape], MaxDegree: Optional[int], MaxSegment: Optional[int]) -> None: ...
	@staticmethod
	...
	@staticmethod
	def EvalMaxDistanceAlongParameter(self, Curve: Adaptor3d_Curve, AReferenceCurve: Adaptor3d_Curve, Tolerance: float, Parameters: TColStd_Array1OfReal, MaxDistance: float) -> None: ...
	@staticmethod
	def EvalMaxParametricDistance(self, Curve: Adaptor3d_Curve, AReferenceCurve: Adaptor3d_Curve, Tolerance: float, Parameters: TColStd_Array1OfReal, MaxDistance: float) -> None: ...
	@staticmethod
	...
	@staticmethod
	def Inertia(self, Points: TColgp_Array1OfPnt, Bary: gp_Pnt, XDir: gp_Dir, YDir: gp_Dir, Xgap: float, YGap: float, ZGap: float) -> None: ...
	@staticmethod
	...
	@staticmethod
	def IsClosed(self, S: Geom_Surface, Tol: float, isUClosed: bool, isVClosed: bool) -> None: ...
	@staticmethod
...
class GeomLib_Check2dBSplineCurve:
	...
	def NeedTangentFix(self, FirstFlag: bool, SecondFlag: bool) -> None: ...
...
class GeomLib_CheckCurveOnSurface:
	...
	def Range(self, theFirst: float, theLast: float) -> None: ...
...
class GeomLib_Tool:
	@staticmethod
	def Parameter(self, Curve: Geom_Curve, Point: gp_Pnt, MaxDist: float, U: float) -> bool: ...
	@staticmethod
	def Parameter(self, Curve: Geom2d_Curve, Point: gp_Pnt2d, MaxDist: float, U: float) -> bool: ...
	@staticmethod
	def Parameters(self, Surface: Geom_Surface, Point: gp_Pnt, MaxDist: float, U: float, V: float) -> bool: ...
