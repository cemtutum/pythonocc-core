...
class math_BracketMinimum:
	...
	def FunctionValues(self, FA: float, FB: float, FC: float) -> None: ...
	def IsDone(self) -> bool: ...
	...
	def Values(self, A: float, B: float, C: float) -> None: ...
...
class math_FunctionAllRoots:
	...
	def GetInterval(self, Index: int, A: float, B: float) -> None: ...
	def GetIntervalState(self, Index: int, IFirst: int, ILast: int) -> None: ...
...
class math_FunctionSample:
	...
	def Bounds(self, A: float, B: float) -> None: ...
...
class math_GlobOptMin:
	...
	def GetTol(self, theDiscretizationTol: float, theSameTol: float) -> None: ...
...
class math_KronrodSingleIntegration:
	...
	@staticmethod
	def GKRule(self, theFunction: math_Function, theLower: float, theUpper: float, theGaussP: math_Vector, theGaussW: math_Vector, theKronrodP: math_Vector, theKronrodW: math_Vector, theValue: float, theError: float) -> bool: ...
	def IsDone(self) -> bool: ...
...
class math_PSO:
	...
	def Perform(self, theSteps: math_Vector, theValue: float, theOutPnt: math_Vector, theNbIter: Optional[int]) -> None: ...
	def Perform(self, theParticles: math_PSOParticlesPool, theNbParticles: int, theValue: float, theOutPnt: math_Vector, theNbIter: Optional[int]) -> None: ...
