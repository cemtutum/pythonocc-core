...
class GeomProjLib:
	@staticmethod
	def Curve2d(self, C: Geom_Curve, First: float, Last: float, S: Geom_Surface, UFirst: float, ULast: float, VFirst: float, VLast: float, Tolerance: float) -> Geom2d_Curve: ...
	@staticmethod
	def Curve2d(self, C: Geom_Curve, First: float, Last: float, S: Geom_Surface, Tolerance: float) -> Geom2d_Curve: ...
	@staticmethod
	...
	@staticmethod
	def Curve2d(self, C: Geom_Curve, S: Geom_Surface, UDeb: float, UFin: float, VDeb: float, VFin: float, Tolerance: float) -> Geom2d_Curve: ...
	@staticmethod
