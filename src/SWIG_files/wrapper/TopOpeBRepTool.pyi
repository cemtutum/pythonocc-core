...
class TopOpeBRepTool_C2DF:
	...
	def PC(self, f2d: float, l2d: float, tol: float) -> Geom2d_Curve: ...
...
class TopOpeBRepTool_CORRISO:
	...
	def EdgeOUTofBoundsUV(self, E: TopoDS_Edge, onU: bool, tolx: float, parspE: float) -> int: ...
	def EdgeWithFaultyUV(self, E: TopoDS_Edge, Ivfaulty: int) -> bool: ...
	def EdgeWithFaultyUV(self, EdsToCheck: TopTools_ListOfShape, nfybounds: int, fyE: TopoDS_Shape, Ifaulty: int) -> bool: ...
...
class TopOpeBRepTool_CurveTool:
	...
	def MakeCurves(self, min: float, max: float, C3D: Geom_Curve, PC1: Geom2d_Curve, PC2: Geom2d_Curve, S1: TopoDS_Shape, S2: TopoDS_Shape, C3DN: Geom_Curve, PC1N: Geom2d_Curve, PC2N: Geom2d_Curve, Tol3d: float, Tol2d: float) -> bool: ...
	@staticmethod
	def MakePCurveOnFace(self, S: TopoDS_Shape, C: Geom_Curve, TolReached2d: float, first: Optional[float], last: Optional[float]) -> Geom2d_Curve: ...
...
class TopOpeBRepTool_GeomTool:
	...
	def GetTolerances(self, tol3d: float, tol2d: float) -> None: ...
...
class TopOpeBRepTool_ShapeTool:
	@staticmethod
	def AdjustOnPeriodic(self, S: TopoDS_Shape, u: float, v: float) -> None: ...
	@staticmethod
	...
	@staticmethod
	def EdgeData(self, BRAC: BRepAdaptor_Curve, P: float, T: gp_Dir, N: gp_Dir, C: float) -> float: ...
	@staticmethod
	def EdgeData(self, E: TopoDS_Shape, P: float, T: gp_Dir, N: gp_Dir, C: float) -> float: ...
	@staticmethod
	...
	@staticmethod
	def UVBOUNDS(self, S: Geom_Surface, UPeri: bool, VPeri: bool, Umin: float, Umax: float, Vmin: float, Vmax: float) -> None: ...
	@staticmethod
	def UVBOUNDS(self, F: TopoDS_Face, UPeri: bool, VPeri: bool, Umin: float, Umax: float, Vmin: float, Vmax: float) -> None: ...
...
class TopOpeBRepTool_TOOL:
	...
	@staticmethod
	def CurvE(self, E: TopoDS_Edge, par: float, tg0: gp_Dir, Curv: float) -> bool: ...
	@staticmethod
	def CurvF(self, F: TopoDS_Face, uv: gp_Pnt2d, tg0: gp_Dir, Curv: float, direct: bool) -> bool: ...
	@staticmethod
	def EdgeONFace(self, par: float, ed: TopoDS_Edge, uv: gp_Pnt2d, fa: TopoDS_Face, isonfa: bool) -> bool: ...
	@staticmethod
	...
	@staticmethod
	def Matter(self, xx1: gp_Dir, nt1: gp_Dir, xx2: gp_Dir, nt2: gp_Dir, tola: float, Ang: float) -> bool: ...
	@staticmethod
	def Matter(self, f1: TopoDS_Face, f2: TopoDS_Face, e: TopoDS_Edge, pare: float, tola: float, Ang: float) -> bool: ...
	@staticmethod
	def MatterKPtg(self, f1: TopoDS_Face, f2: TopoDS_Face, e: TopoDS_Edge, Ang: float) -> bool: ...
	@staticmethod
	...
	@staticmethod
	def ParE2d(self, p2d: gp_Pnt2d, e: TopoDS_Edge, f: TopoDS_Face, par: float, dist: float) -> bool: ...
	@staticmethod
	def ParISO(self, p2d: gp_Pnt2d, e: TopoDS_Edge, f: TopoDS_Face, pare: float) -> bool: ...
	@staticmethod
	...
	@staticmethod
	def TgINSIDE(self, v: TopoDS_Vertex, E: TopoDS_Edge, Tg: gp_Vec, OvinE: int) -> bool: ...
	@staticmethod
	...
	@staticmethod
	def UVISO(self, PC: Geom2d_Curve, isou: bool, isov: bool, d2d: gp_Dir2d, o2d: gp_Pnt2d) -> bool: ...
	@staticmethod
	def UVISO(self, C2DF: TopOpeBRepTool_C2DF, isou: bool, isov: bool, d2d: gp_Dir2d, o2d: gp_Pnt2d) -> bool: ...
	@staticmethod
	def UVISO(self, E: TopoDS_Edge, F: TopoDS_Face, isou: bool, isov: bool, d2d: gp_Dir2d, o2d: gp_Pnt2d) -> bool: ...
	@staticmethod
	...
	@staticmethod
	def stuvF(self, uv: gp_Pnt2d, F: TopoDS_Face, onU: int, onV: int) -> None: ...
	@staticmethod
