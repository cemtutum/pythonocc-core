...
class FairCurve_Batten:
	...
	def Compute(self, Code: FairCurve_AnalysisCode, NbIterations: Optional[int], Tolerance: Optional[float]) -> bool: ...
...
class FairCurve_Energy(math_MultipleVarFunctionWithHessian):
	...
	def Value(self, X: math_Vector, E: float) -> bool: ...
	def Values(self, X: math_Vector, E: float, G: math_Vector) -> bool: ...
	def Values(self, X: math_Vector, E: float, G: math_Vector, H: math_Matrix) -> bool: ...
...
class FairCurve_MinimalVariation(FairCurve_Batten):
	...
	def Compute(self, ACode: FairCurve_AnalysisCode, NbIterations: Optional[int], Tolerance: Optional[float]) -> bool: ...
