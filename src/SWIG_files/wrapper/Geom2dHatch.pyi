...
class Geom2dHatch_Elements:
	...
	def OtherSegment(self, P: gp_Pnt2d, L: gp_Lin2d, Par: float) -> bool: ...
	...
	def Segment(self, P: gp_Pnt2d, L: gp_Lin2d, Par: float) -> bool: ...
...
class Geom2dHatch_Intersector(Geom2dInt_GInter):
	...
	def LocalGeometry(self, E: Geom2dAdaptor_Curve, U: float, T: gp_Dir2d, N: gp_Dir2d, C: float) -> None: ...
