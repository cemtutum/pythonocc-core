...
class Interface_BitMap:
	...
	def Internals(self, nbitems: int, nbwords: int, nbflags: int, flags: TColStd_HArray1OfInteger, names: TColStd_HSequenceOfAsciiString) -> None: ...
	def Length(self) -> int: ...
...
class Interface_FloatWriter:
	...
	def Options(self, zerosup: bool, range: bool, R1: float, R2: float) -> None: ...
...
class Interface_GTool(Standard_Transient):
	...
	def Select(self, ent: Standard_Transient, gmod: Interface_GeneralModule, CN: int, enforce: Optional[bool]) -> bool: ...
...
class Interface_GeneralLib:
	...
	def Next(self) -> None: ...
	def Protocol(self) -> Interface_Protocol: ...
	def Select(self, obj: Standard_Transient, module: Interface_GeneralModule, CN: int) -> bool: ...
...
class Interface_IntList:
	...
	def Internals(self, nbrefs: int, ents: TColStd_HArray1OfInteger, refs: TColStd_HArray1OfInteger) -> None: ...
...
class Interface_MSG:
	...
	@staticmethod
	def NDate(self, text: str, yy: int, mm: int, dd: int, hh: int, mn: int, ss: int) -> bool: ...
	@staticmethod
...
class Interface_ReaderLib:
	...
	def Next(self) -> None: ...
	def Protocol(self) -> Interface_Protocol: ...
	def Select(self, obj: Standard_Transient, module: Interface_ReaderModule, CN: int) -> bool: ...
	def SetComplete(self) -> None: ...
	@staticmethod
...
class Interface_STAT:
	...
	def Description(self, nbphases: int, total: float, title: str) -> None: ...
	@staticmethod
	def End(self) -> None: ...
	def Internals(self, tit: TCollection_HAsciiString, total: float, phn: TColStd_HSequenceOfAsciiString, phw: TColStd_HSequenceOfReal, phdeb: TColStd_HSequenceOfInteger, phfin: TColStd_HSequenceOfInteger, stw: TColStd_HSequenceOfReal) -> None: ...
	@staticmethod
	...
	def Phase(self, num: int, n0step: int, nbstep: int, weight: float, name: str) -> None: ...
	@staticmethod
