...
class IntAna_Curve:
	...
	def Domain(self, theFirst: float, theLast: float) -> None: ...
...
class IntAna_IntLinTorus:
	...
	def ParamOnTorus(self, Index: int, FI: float, THETA: float) -> None: ...
...
class IntAna_IntQuadQuad:
	...
	def Parameters(self, N: int, U1: float, U2: float) -> None: ...
...
class IntAna_Quadric:
	...
	def Coefficients(self, xCXX: float, xCYY: float, xCZZ: float, xCXY: float, xCXZ: float, xCYZ: float, xCX: float, xCY: float, xCZ: float, xCCte: float) -> None: ...
	def NewCoefficients(self, xCXX: float, xCYY: float, xCZZ: float, xCXY: float, xCXZ: float, xCYZ: float, xCX: float, xCY: float, xCZ: float, xCCte: float, Axis: gp_Ax3) -> None: ...
