...
class MeshVS_DataSource(Standard_Transient):
	...
	def GetDetectedEntities(self, Prs: MeshVS_Mesh, X: float, Y: float, aTol: float, Nodes: TColStd_HPackedMapOfInteger, Elements: TColStd_HPackedMapOfInteger, DMin: float) -> bool: ...
	...
	def GetGeom(self, ID: int, IsElement: bool, Coords: TColStd_Array1OfReal, NbNodes: int, Type: MeshVS_EntityType) -> bool: ...
	...
	def GetNodesByElement(self, ID: int, NodeIDs: TColStd_Array1OfInteger, NbNodes: int) -> bool: ...
...
class MeshVS_MeshPrsBuilder(MeshVS_PrsBuilder):
	...
	@staticmethod
	def HowManyPrimitives(self, Topo: MeshVS_HArray1OfSequenceOfInteger, AsPolygons: bool, IsSelect: bool, NbNodes: int, Vertices: int, Bounds: int) -> None: ...
...
class MeshVS_VectorPrsBuilder(MeshVS_PrsBuilder):
	...
	def GetMinMaxVectorValue(self, IsElement: bool, MinValue: float, MaxValue: float) -> None: ...
