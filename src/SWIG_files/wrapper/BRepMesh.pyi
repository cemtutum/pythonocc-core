...
) = NewType(')', Standard_Integer ( BRepMesh_PluginEntryType ) ( const TopoDS_Shape & theShape, const Standard_Real theLinDeflection, const Standard_Real theAngDeflection, BRepMesh_DiscretRoot & theMeshAlgoInstance)
...
class BRepMesh_DataStructureOfDelaun(Standard_Transient):
	...
	def ElementNodes(self, theElement: BRepMesh_Triangle, )[3]: int) -> None: ...
...
class BRepMesh_MeshTool(Standard_Transient):
	...
	def AddTriangle(self, thePoint1: int, thePoint2: int, thePoint3: int, )[3]: int) -> None: ...
...
class BRepMesh_Triangle:
	def __init__(self) -> None: ...
	def __init__(self, )[3]: int, )[3]: bool, theMovability: BRepMesh_DegreeOfFreedom) -> None: ...
	def Edges(self, )[3]: int, )[3]: bool) -> None: ...
	def HashCode(self, theUpperBound: int) -> int: ...
	def Initialize(self, )[3]: int, )[3]: bool, theMovability: BRepMesh_DegreeOfFreedom) -> None: ...
