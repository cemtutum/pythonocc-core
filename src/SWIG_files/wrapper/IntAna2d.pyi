...
class IntAna2d_Conic:
	...
	def NewCoefficients(self, A: float, B: float, C: float, D: float, E: float, F: float, Axis: gp_Ax2d) -> None: ...
	def ValAndGrad(self, X: float, Y: float, Val: float, Grd: gp_XY) -> None: ...
