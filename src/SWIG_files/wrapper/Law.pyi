...
class Law_BSpline(Standard_Transient):
	...
	def D0(self, U: float, P: float) -> None: ...
	def D1(self, U: float, P: float, V1: float) -> None: ...
	def D2(self, U: float, P: float, V1: float, V2: float) -> None: ...
	def D3(self, U: float, P: float, V1: float, V2: float, V3: float) -> None: ...
	...
	def LocalD0(self, U: float, FromK1: int, ToK2: int, P: float) -> None: ...
	def LocalD1(self, U: float, FromK1: int, ToK2: int, P: float, V1: float) -> None: ...
	def LocalD2(self, U: float, FromK1: int, ToK2: int, P: float, V1: float, V2: float) -> None: ...
	def LocalD3(self, U: float, FromK1: int, ToK2: int, P: float, V1: float, V2: float, V3: float) -> None: ...
	...
	def MovePointAndTangent(self, U: float, NewValue: float, Derivative: float, Tolerance: float, StartingCondition: int, EndingCondition: int, ErrorStatus: int) -> None: ...
...
class Law_Function(Standard_Transient):
	def Bounds(self, PFirst: float, PLast: float) -> None: ...
	def Continuity(self) -> GeomAbs_Shape: ...
	def D1(self, X: float, F: float, D: float) -> None: ...
	def D2(self, X: float, F: float, D: float, D2: float) -> None: ...
