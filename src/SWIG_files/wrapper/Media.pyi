...
class Media_PlayerContext(Standard_Transient):
	...
	def Pause(self) -> None: ...
	def PlayPause(self, theIsPaused: bool, theProgress: float, theDuration: float) -> None: ...
	def PlaybackState(self, theIsPaused: bool, theProgress: float, theDuration: float) -> None: ...
