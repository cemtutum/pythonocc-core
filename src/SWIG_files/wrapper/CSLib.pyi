...
class CSLib:
	...
	@staticmethod
	def Normal(self, D1U: gp_Vec, D1V: gp_Vec, D2U: gp_Vec, D2V: gp_Vec, D2UV: gp_Vec, SinTol: float, Done: bool, theStatus: CSLib_NormalStatus, Normal: gp_Dir) -> None: ...
	@staticmethod
	def Normal(self, D1U: gp_Vec, D1V: gp_Vec, MagTol: float, theStatus: CSLib_NormalStatus, Normal: gp_Dir) -> None: ...
	@staticmethod
	def Normal(self, MaxOrder: int, DerNUV: TColgp_Array2OfVec, MagTol: float, U: float, V: float, Umin: float, Umax: float, Vmin: float, Vmax: float, theStatus: CSLib_NormalStatus, Normal: gp_Dir, OrderU: int, OrderV: int) -> None: ...
