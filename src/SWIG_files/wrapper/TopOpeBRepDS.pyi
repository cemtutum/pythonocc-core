...
class TopOpeBRepDS_BuildTool:
	...
	def ApproxCurves(self, C: TopOpeBRepDS_Curve, E: TopoDS_Edge, inewC: int, HDS: TopOpeBRepDS_HDataStructure) -> None: ...
	...
	def GetOrientedEdgeVertices(self, E: TopoDS_Edge, Vmin: TopoDS_Vertex, Vmax: TopoDS_Vertex, Parmin: float, Parmax: float) -> None: ...
	...
	def RecomputeCurves(self, C: TopOpeBRepDS_Curve, oldE: TopoDS_Edge, E: TopoDS_Edge, inewC: int, HDS: TopOpeBRepDS_HDataStructure) -> None: ...
	def Translate(self) -> bool: ...
	def Translate(self, T: bool) -> None: ...
	def UpdateEdge(self, Ein: TopoDS_Shape, Eou: TopoDS_Shape) -> None: ...
	def UpdateEdgeCurveTol(self, F1: TopoDS_Face, F2: TopoDS_Face, E: TopoDS_Edge, C3Dnew: Geom_Curve, tol3d: float, tol2d1: float, tol2d2: float, newtol: float, newparmin: float, newparmax: float) -> None: ...
...
class TopOpeBRepDS_DataStructure:
	...
	def ChangeMapOfShapeWithState(self, aShape: TopoDS_Shape, aFlag: bool) -> TopOpeBRepDS_IndexedDataMapOfShapeWithState: ...
...
class TopOpeBRepDS_FaceInterferenceTool:
	...
	def GetEdgePntPar(self, P: gp_Pnt, par: float) -> None: ...
...
class TopOpeBRepDS_GapTool(Standard_Transient):
	...
	def ParameterOnEdge(self, I: TopOpeBRepDS_Interference, E: TopoDS_Shape, U: float) -> bool: ...
...
class TopOpeBRepDS_Interference(Standard_Transient):
	...
	def GKGSKS(self, GK: TopOpeBRepDS_Kind, G: int, SK: TopOpeBRepDS_Kind, S: int) -> None: ...
...
class TopOpeBRepDS_TOOL:
	...
	@staticmethod
	def GetConfig(self, HDS: TopOpeBRepDS_HDataStructure, MEspON: TopOpeBRepDS_DataMapOfShapeListOfShapeOn1State, ie: int, iesd: int, conf: int) -> bool: ...
	@staticmethod
	def GetEsd(self, HDS: TopOpeBRepDS_HDataStructure, S: TopoDS_Shape, ie: int, iesd: int) -> bool: ...
	@staticmethod
...
class TopOpeBRepDS_PointData(TopOpeBRepDS_GeometryData):
	...
	def GetShapes(self, I1: int, I2: int) -> None: ...
