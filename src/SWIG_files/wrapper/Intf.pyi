...
class Intf:
	...
	@staticmethod
	def PlaneEquation(self, P1: gp_Pnt, P2: gp_Pnt, P3: gp_Pnt, NormalVector: gp_XYZ, PolarDistance: float) -> None: ...
...
class Intf_SectionPoint:
	...
	def InfoFirst(self, Dim: Intf_PIType, Add1: int, Add2: int, Param: float) -> None: ...
	def InfoFirst(self, Dim: Intf_PIType, Addr: int, Param: float) -> None: ...
	def InfoSecond(self, Dim: Intf_PIType, Add1: int, Add2: int, Param: float) -> None: ...
	def InfoSecond(self, Dim: Intf_PIType, Addr: int, Param: float) -> None: ...
	def __init__(self) -> None: ...
...
class Intf_TangentZone:
	...
	def InfoFirst(self, segMin: int, paraMin: float, segMax: int, paraMax: float) -> None: ...
	def InfoSecond(self, segMin: int, paraMin: float, segMax: int, paraMax: float) -> None: ...
	...
	def NumberOfPoints(self) -> int: ...
	def ParamOnFirst(self, paraMin: float, paraMax: float) -> None: ...
	def ParamOnSecond(self, paraMin: float, paraMax: float) -> None: ...
