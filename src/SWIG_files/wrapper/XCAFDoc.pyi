...
class XCAFDoc_Area(TDF_Attribute):
	def Get(self) -> float: ...
	@staticmethod
	def Get(self, label: TDF_Label, area: float) -> bool: ...
	@staticmethod
...
class XCAFDoc_ClippingPlaneTool(TDF_Attribute):
	...
	def GetCapping(self, theClippingPlaneL: TDF_Label, theCapping: bool) -> bool: ...
	def GetClippingPlane(self, theLabel: TDF_Label, thePlane: gp_Pln, theName: TCollection_ExtendedString, theCapping: bool) -> bool: ...
	def GetClippingPlane(self, theLabel: TDF_Label, thePlane: gp_Pln, theName: TCollection_HAsciiString, theCapping: bool) -> bool: ...
...
class XCAFDoc_Color(TDF_Attribute):
	...
	def GetRGB(self, R: float, G: float, B: float) -> None: ...
	def ID(self) -> Standard_GUID: ...
	def NewEmpty(self) -> TDF_Attribute: ...
	def Paste(self, Into: TDF_Attribute, RT: TDF_RelocationTable) -> None: ...
	def Restore(self, With: TDF_Attribute) -> None: ...
...
class XCAFDoc_MaterialTool(TDF_Attribute):
	...
	@staticmethod
	def GetID(self) -> Standard_GUID: ...
	def GetMaterial(self, MatL: TDF_Label, aName: TCollection_HAsciiString, aDescription: TCollection_HAsciiString, aDensity: float, aDensName: TCollection_HAsciiString, aDensValType: TCollection_HAsciiString) -> bool: ...
...
class XCAFDoc_Volume(TDF_Attribute):
	def Get(self) -> float: ...
	@staticmethod
	def Get(self, label: TDF_Label, vol: float) -> bool: ...
	@staticmethod
	def GetID(self) -> Standard_GUID: ...
	def ID(self) -> Standard_GUID: ...
	def NewEmpty(self) -> TDF_Attribute: ...
