...
class Convert_ConicToBSplineCurve:
	def BuildCosAndSin(self, Parametrisation: Convert_ParameterisationType, CosNumerator: TColStd_HArray1OfReal, SinNumerator: TColStd_HArray1OfReal, Denominator: TColStd_HArray1OfReal, Degree: int, Knots: TColStd_HArray1OfReal, Mults: TColStd_HArray1OfInteger) -> None: ...
	def BuildCosAndSin(self, Parametrisation: Convert_ParameterisationType, UFirst: float, ULast: float, CosNumerator: TColStd_HArray1OfReal, SinNumerator: TColStd_HArray1OfReal, Denominator: TColStd_HArray1OfReal, Degree: int, Knots: TColStd_HArray1OfReal, Mults: TColStd_HArray1OfInteger) -> None: ...
	def Degree(self) -> int: ...
