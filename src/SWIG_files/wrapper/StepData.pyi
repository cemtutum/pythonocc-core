...
class StepData_StepReaderData(Interface_FileReaderData):
	...
	def NamedForComplex(self, name: str, num0: int, num: int, ach: Interface_Check) -> bool: ...
	def NamedForComplex(self, theName: str, theShortName: str, num0: int, num: int, ach: Interface_Check) -> bool: ...
	...
	def ReadBoolean(self, num: int, nump: int, mess: str, ach: Interface_Check, flag: bool) -> bool: ...
	def ReadEnum(self, num: int, nump: int, mess: str, ach: Interface_Check, enumtool: StepData_EnumTool, val: int) -> bool: ...
	...
	def ReadInteger(self, num: int, nump: int, mess: str, ach: Interface_Check, val: int) -> bool: ...
	...
	def ReadReal(self, num: int, nump: int, mess: str, ach: Interface_Check, val: float) -> bool: ...
	...
	def ReadSubList(self, num: int, nump: int, mess: str, ach: Interface_Check, numsub: int, optional: Optional[bool], lenmin: Optional[int], lenmax: Optional[int]) -> bool: ...
	def ReadTypedParam(self, num: int, nump: int, mustbetyped: bool, mess: str, ach: Interface_Check, numr: int, numrp: int, typ: TCollection_AsciiString) -> bool: ...
	def ReadXY(self, num: int, nump: int, mess: str, ach: Interface_Check, X: float, Y: float) -> bool: ...
	def ReadXYZ(self, num: int, nump: int, mess: str, ach: Interface_Check, X: float, Y: float, Z: float) -> bool: ...
...
class StepData_WriterLib:
	...
	def Next(self) -> None: ...
	def Protocol(self) -> StepData_Protocol: ...
	def Select(self, obj: Standard_Transient, module: StepData_ReadWriteModule, CN: int) -> bool: ...
