...
class LocOpe_CSIntersector:
	...
	def IsDone(self) -> bool: ...
	def LocalizeAfter(self, I: int, From: float, Tol: float, Or: TopAbs_Orientation, IndFrom: int, IndTo: int) -> bool: ...
	def LocalizeAfter(self, I: int, FromInd: int, Tol: float, Or: TopAbs_Orientation, IndFrom: int, IndTo: int) -> bool: ...
	def LocalizeBefore(self, I: int, From: float, Tol: float, Or: TopAbs_Orientation, IndFrom: int, IndTo: int) -> bool: ...
	def LocalizeBefore(self, I: int, FromInd: int, Tol: float, Or: TopAbs_Orientation, IndFrom: int, IndTo: int) -> bool: ...
...
class LocOpe_CurveShapeIntersector:
	...
	def IsDone(self) -> bool: ...
	def LocalizeAfter(self, From: float, Or: TopAbs_Orientation, IndFrom: int, IndTo: int) -> bool: ...
	def LocalizeAfter(self, FromInd: int, Or: TopAbs_Orientation, IndFrom: int, IndTo: int) -> bool: ...
	def LocalizeBefore(self, From: float, Or: TopAbs_Orientation, IndFrom: int, IndTo: int) -> bool: ...
	def LocalizeBefore(self, FromInd: int, Or: TopAbs_Orientation, IndFrom: int, IndTo: int) -> bool: ...
...
class LocOpe_WiresOnShape(Standard_Transient):
	...
	def OnEdge(self, V: TopoDS_Vertex, E: TopoDS_Edge, P: float) -> bool: ...
	def OnEdge(self, V: TopoDS_Vertex, EdgeFrom: TopoDS_Edge, E: TopoDS_Edge, P: float) -> bool: ...
