...
class MAT_Graph(Standard_Transient):
	...
	def FusionOfBasicElts(self, IndexElt1: int, IndexElt2: int, MergeArc1: bool, GeomIndexArc1: int, GeomIndexArc2: int, MergeArc2: bool, GeomIndexArc3: int, GeomIndexArc4: int) -> None: ...
	def __init__(self) -> None: ...
