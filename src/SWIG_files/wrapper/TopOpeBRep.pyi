...
class TopOpeBRep_EdgesIntersector:
	...
	def Tolerances(self, tol1: float, tol2: float) -> None: ...
	def __init__(self) -> None: ...
...
class TopOpeBRep_FacesFiller:
	...
	def GetFFGeometry(self, DSP: TopOpeBRepDS_Point, K: TopOpeBRepDS_Kind, G: int) -> bool: ...
	def GetFFGeometry(self, VP: TopOpeBRep_VPointInter, K: TopOpeBRepDS_Kind, G: int) -> bool: ...
	def GetGeometry(self, IT: TopOpeBRepDS_ListIteratorOfListOfInterference, VP: TopOpeBRep_VPointInter, G: int, K: TopOpeBRepDS_Kind) -> bool: ...
	def GetTraceIndex(self, exF1: int, exF2: int) -> None: ...
	...
	@staticmethod
	def Lminmax(self, L: TopOpeBRep_LineInter, pmin: float, pmax: float) -> None: ...
	...
	def ProcessVPondgE(self, VP: TopOpeBRep_VPointInter, ShapeIndex: int, PVKind: TopOpeBRepDS_Kind, PVIndex: int, EPIfound: bool, IEPI: TopOpeBRepDS_Interference, CPIfound: bool, ICPI: TopOpeBRepDS_Interference) -> bool: ...
...
class TopOpeBRep_FacesIntersector:
	...
	def GetTolerances(self, tolarc: float, toltang: float) -> None: ...
...
class TopOpeBRep_Hctxff2d(Standard_Transient):
	...
	def GetTolerances(self, Tol1: float, Tol2: float) -> None: ...
...
class TopOpeBRep_LineInter:
	...
	def Bounds(self, f: float, l: float) -> None: ...
	...
	def VPBounds(self, f: int, l: int, n: int) -> None: ...
...
class TopOpeBRep_VPointInter:
	...
	def ParametersOnS1(self, u: float, v: float) -> None: ...
	def ParametersOnS2(self, u: float, v: float) -> None: ...
	def ParonE(self, E: TopoDS_Edge, par: float) -> bool: ...
