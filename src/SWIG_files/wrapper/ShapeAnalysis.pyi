...
class ShapeAnalysis:
	...
	@staticmethod
	def GetFaceUVBounds(self, F: TopoDS_Face, Umin: float, Umax: float, Vmin: float, Vmax: float) -> None: ...
	@staticmethod
...
class ShapeAnalysis_CheckSmallFace:
	...
	def CheckPin(self, F: TopoDS_Face, whatrow: int, sence: int) -> bool: ...
	...
	def CheckStripEdges(self, E1: TopoDS_Edge, E2: TopoDS_Edge, tol: float, dmax: float) -> bool: ...
	def CheckStripFace(self, F: TopoDS_Face, E1: TopoDS_Edge, E2: TopoDS_Edge, tol: Optional[float]) -> bool: ...
	def CheckTwisted(self, F: TopoDS_Face, paramu: float, paramv: float) -> bool: ...
	def FindStripEdges(self, F: TopoDS_Face, E1: TopoDS_Edge, E2: TopoDS_Edge, tol: float, dmax: float) -> bool: ...
	def IsSpotFace(self, F: TopoDS_Face, spot: gp_Pnt, spotol: float, tol: Optional[float]) -> int: ...
...
class ShapeAnalysis_Curve:
	...
	def NextProject(self, paramPrev: float, C3D: Geom_Curve, P3D: gp_Pnt, preci: float, proj: gp_Pnt, param: float, cf: float, cl: float, AdjustToEnds: Optional[bool]) -> float: ...
	def NextProject(self, paramPrev: float, C3D: Adaptor3d_Curve, P3D: gp_Pnt, preci: float, proj: gp_Pnt, param: float) -> float: ...
	def Project(self, C3D: Geom_Curve, P3D: gp_Pnt, preci: float, proj: gp_Pnt, param: float, AdjustToEnds: Optional[bool]) -> float: ...
	def Project(self, C3D: Adaptor3d_Curve, P3D: gp_Pnt, preci: float, proj: gp_Pnt, param: float, AdjustToEnds: Optional[bool]) -> float: ...
	def Project(self, C3D: Geom_Curve, P3D: gp_Pnt, preci: float, proj: gp_Pnt, param: float, cf: float, cl: float, AdjustToEnds: Optional[bool]) -> float: ...
	def ProjectAct(self, C3D: Adaptor3d_Curve, P3D: gp_Pnt, preci: float, proj: gp_Pnt, param: float) -> float: ...
	def SelectForwardSeam(self, C1: Geom2d_Curve, C2: Geom2d_Curve) -> int: ...
	def ValidateRange(self, Crv: Geom_Curve, First: float, Last: float, prec: float) -> bool: ...
...
class ShapeAnalysis_Edge:
	...
	def CheckOverlapping(self, theEdge1: TopoDS_Edge, theEdge2: TopoDS_Edge, theTolOverlap: float, theDomainDist: Optional[float]) -> bool: ...
	def CheckPCurveRange(self, theFirst: float, theLast: float, thePC: Geom2d_Curve) -> bool: ...
	def CheckSameParameter(self, edge: TopoDS_Edge, maxdev: float, NbControl: Optional[int]) -> bool: ...
	def CheckSameParameter(self, theEdge: TopoDS_Edge, theFace: TopoDS_Face, theMaxdev: float, theNbControl: Optional[int]) -> bool: ...
	def CheckVertexTolerance(self, edge: TopoDS_Edge, face: TopoDS_Face, toler1: float, toler2: float) -> bool: ...
	def CheckVertexTolerance(self, edge: TopoDS_Edge, toler1: float, toler2: float) -> bool: ...
	...
	@staticmethod
	def ComputeDeviation(self, CRef: Adaptor3d_Curve, Other: Adaptor3d_Curve, SameParameter: bool, dev: float, NCONTROL: int) -> bool: ...
	def Curve3d(self, edge: TopoDS_Edge, C3d: Geom_Curve, cf: float, cl: float, orient: Optional[bool]) -> bool: ...
	...
	def PCurve(self, edge: TopoDS_Edge, face: TopoDS_Face, C2d: Geom2d_Curve, cf: float, cl: float, orient: Optional[bool]) -> bool: ...
	def PCurve(self, edge: TopoDS_Edge, surface: Geom_Surface, location: TopLoc_Location, C2d: Geom2d_Curve, cf: float, cl: float, orient: Optional[bool]) -> bool: ...
	def Status(self, status: ShapeExtend_Status) -> bool: ...
...
class ShapeAnalysis_FreeBoundsProperties:
	...
	def CheckNotches(self, freebound: TopoDS_Wire, num: int, notch: TopoDS_Wire, distMax: float, prec: Optional[float]) -> bool: ...
...
class ShapeAnalysis_Geom:
	@staticmethod
	def NearestPlane(self, Pnts: TColgp_Array1OfPnt, aPln: gp_Pln, Dmax: float) -> bool: ...
	@staticmethod
...
class ShapeAnalysis_Surface(Standard_Transient):
	...
	def Bounds(self, ufirst: float, ulast: float, vfirst: float, vlast: float) -> None: ...
	def ComputeBoundIsos(self) -> None: ...
	def DegeneratedValues(self, P3d: gp_Pnt, preci: float, firstP2d: gp_Pnt2d, lastP2d: gp_Pnt2d, firstpar: float, lastpar: float, forward: Optional[bool]) -> bool: ...
	def Gap(self) -> float: ...
	...
	def Singularity(self, num: int, preci: float, P3d: gp_Pnt, firstP2d: gp_Pnt2d, lastP2d: gp_Pnt2d, firstpar: float, lastpar: float, uisodeg: bool) -> bool: ...
	...
	def UVFromIso(self, P3D: gp_Pnt, preci: float, U: float, V: float) -> float: ...
...
class ShapeAnalysis_Wire(Standard_Transient):
	...
	def CheckNotchedEdges(self, num: int, shortNum: int, param: float, Tolerance: Optional[float]) -> bool: ...
	...
	def CheckSeam(self, num: int, C1: Geom2d_Curve, C2: Geom2d_Curve, cf: float, cl: float) -> bool: ...
	...
	def CheckShapeConnect(self, tailhead: float, tailtail: float, headtail: float, headhead: float, shape: TopoDS_Shape, prec: Optional[float]) -> bool: ...
...
class ShapeAnalysis_WireOrder:
	...
	def Chain(self, num: int, n1: int, n2: int) -> None: ...
	def Clear(self) -> None: ...
	def Couple(self, num: int, n1: int, n2: int) -> None: ...
...
class ShapeAnalysis_WireVertex:
	...
	def Data(self, num: int, pos: gp_XYZ, upre: float, ufol: float) -> int: ...
