...
class ChFiDS_CircSection:
	...
	def Get(self, C: gp_Circ, F: float, L: float) -> None: ...
	def Get(self, C: gp_Lin, F: float, L: float) -> None: ...
...
class ChFiDS_Spine(Standard_Transient):
	...
	def Parameter(self, AbsC: float, U: float, Oriented: Optional[bool]) -> None: ...
	def Parameter(self, Index: int, AbsC: float, U: float, Oriented: Optional[bool]) -> None: ...
	def Period(self) -> float: ...
...
class ChFiDS_Stripe(Standard_Transient):
	...
	def FirstParameters(self, Pdeb: float, Pfin: float) -> None: ...
	...
	def LastParameters(self, Pdeb: float, Pfin: float) -> None: ...
	...
	def Parameters(self, First: bool, Pdeb: float, Pfin: float) -> None: ...
	def Reset(self) -> None: ...
...
class ChFiDS_ChamfSpine(ChFiDS_Spine):
	def __init__(self) -> None: ...
	def __init__(self, Tol: float) -> None: ...
	def Dists(self, Dis1: float, Dis2: float) -> None: ...
	def GetDist(self, Dis: float) -> None: ...
	def GetDistAngle(self, Dis: float, Angle: float) -> None: ...
